...
Vous pouvez en savoir plus sur les [raisons pour choisir la concaténation de chaînes ou la `StringBuilder` classe](/dotnet/api/system.text.stringbuilder#the-string-and-stringbuilder-types).

...
- la propriété de classe de base ne déclare pas l’accesseur [get](../../csharp/language-reference/keywords/get.md) ou [set](../../csharp/language-reference/keywords/set.md) que vous voulez remplacer.  
 ...
 Si vous ne voulez pas remplacer la propriété de classe de base, vous pouvez utiliser le mot clé [new](../../csharp/language-reference/keywords/new-modifier.md) avant la propriété dans une classe dérivée.  

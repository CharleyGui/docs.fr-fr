...
- [/PDB (C# options du compilateur)](../language-reference/compiler-options/pdb-compiler-option.md)
- [/Debug (C# options du compilateur)](../language-reference/compiler-options/debug-compiler-option.md)

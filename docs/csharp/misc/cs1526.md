...
Une nouvelle expression requiert des parenthèses (), [], ou {} après le type  
 ...
 L’opérateur [new](../../csharp/language-reference/operators/new-operator.md) , utilisé pour allouer dynamiquement de la mémoire pour un objet, n’a pas été spécifié correctement.  

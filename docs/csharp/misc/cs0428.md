...
---
# <a name="compiler-error-cs0428"></a><span data-ttu-id="78024-102">Erreur du compilateur CS0428</span><span class="sxs-lookup"><span data-stu-id="78024-102">Compiler Error CS0428</span></span>
<span data-ttu-id="78024-103">Impossible de convertir le groupe de méthodes 'Identifier' en type non-délégué 'type'.</span><span class="sxs-lookup"><span data-stu-id="78024-103">Cannot convert method group 'Identifier' to non-delegate type 'type'.</span></span>  <span data-ttu-id="78024-104">Voulez-vous appeler la méthode ?</span><span class="sxs-lookup"><span data-stu-id="78024-104">Did you  intend to invoke the method?</span></span>  
  
 <span data-ttu-id="78024-105">Cette erreur se produit lors de la conversion d’un groupe de méthodes en un type non délégué, ou de la tentative d’appel d’une méthode sans utiliser de parenthèses.</span><span class="sxs-lookup"><span data-stu-id="78024-105">This error occurs when converting a method group to a non-delegate type, or attempting to invoke a method without using parentheses.</span></span>  
  
## <a name="example"></a><span data-ttu-id="78024-106"> Exemple</span><span class="sxs-lookup"><span data-stu-id="78024-106">Example</span></span>  
 <span data-ttu-id="78024-107">L’exemple suivant génère l’erreur CS0428 :</span><span class="sxs-lookup"><span data-stu-id="78024-107">The following sample generates CS0428:</span></span>  

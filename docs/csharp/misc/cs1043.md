...
{ ou ; attendu  
 ...
 Un accesseur de propriété a été déclaré de manière incorrecte. Pour plus d'informations, consultez [Using Properties](../programming-guide/classes-and-structs/using-properties.md).  

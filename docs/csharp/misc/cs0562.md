...
La déclaration de méthode d’une surcharge d’opérateur doit respecter certaines règles. Pour plus d’informations, consultez [la surcharge d’opérateur](../../csharp/language-reference/operators/operator-overloading.md).

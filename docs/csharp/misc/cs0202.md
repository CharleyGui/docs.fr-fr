...
> [!NOTE]
> En C# 2.0, le compilateur génère automatiquement Current et MoveNext pour vous. Pour plus d’informations, consultez l’exemple de code dans les [interfaces génériques](../programming-guide/generics/generic-interfaces.md).  

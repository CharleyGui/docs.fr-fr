...
Le membre conditionnel 'member' ne peut pas implémenter le membre d’interface 'base class member' dans le type 'Type Name'  
 ...
 L’attribut [Conditional](../programming-guide/concepts/attributes/common-attributes.md#Conditional) ne peut pas être utilisé sur l’implémentation d’une interface.  

...
Vous ne pouvez pas utiliser l’instruction [yield](../../csharp/language-reference/keywords/yield.md) dans une [méthode anonyme](../language-reference/operators/delegate-operator.md) ou une [expression lambda](../../csharp/programming-guide/statements-expressions-operators/lambda-expressions.md).

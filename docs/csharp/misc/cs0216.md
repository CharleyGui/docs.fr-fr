...
L’opérateur 'opérateur' exige qu’un opérateur correspondant 'opérateur_manquant' soit aussi défini  
 ...
 Un opérateur défini par l’utilisateur [==](../language-reference/operators/equality-operators#equality-operator-) requiert un opérateur défini [](../language-reference/operators/inequality-operators#inequality-operator-) par l’utilisateur, et vice versa.  

...
La classe de base ou l’interface 'classe' dans l’assembly 'assembly' référencé par le type 'type' n’a pas pu être résolue  
 ...
 Pour plus d’informations, voir [Ajouter la boîte de dialogue de référence](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager) et [-référence (Options de compilateur de C)](../language-reference/compiler-options/reference-compiler-option.md).  
...
- [Ajouter une référence, boîte de dialogue](/visualstudio/ide/how-to-add-or-remove-references-by-using-the-reference-manager)
- [-référence (Options compilateur C)](../language-reference/compiler-options/reference-compiler-option.md)

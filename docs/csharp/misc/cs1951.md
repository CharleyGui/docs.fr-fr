...
Une arborescence d’expression lambda ne peut pas contenir de paramètre in, out ou Ref.  
...
1. La seule option consiste à supprimer le modificateur dans la définition du délégué et à passer le paramètre par valeur.  

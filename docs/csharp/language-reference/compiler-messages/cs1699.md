...
Utilisez l’option de ligne de commande "compiler_option" ou les paramètres de projet appropriés plutôt que "attribute_name".  
 ...
 La rubrique [Guide pratique pour signer un assembly avec un nom fort](../../../standard/assembly/sign-strong-name.md) utilise les options de compilateur suivantes :  
  
- [/keyfile (Options du compilateur C#)](../compiler-options/keyfile-compiler-option.md) au lieu de l’attribut <xref:System.Reflection.AssemblyKeyFileAttribute>.  

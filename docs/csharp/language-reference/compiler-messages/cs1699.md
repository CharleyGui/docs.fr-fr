...
- [-keyfile (Options compilateur C)](../compiler-options/keyfile-compiler-option.md) <xref:System.Reflection.AssemblyKeyFileAttribute> au lieu de l’attribut.  
  
- [-keycontainer (Options compilateur C)](../compiler-options/keycontainer-compiler-option.md) au lieu de <xref:System.Reflection.AssemblyKeyNameAttribute>.  
  
- [-delaysign (C’Compiler Options)](../compiler-options/delaysign-compiler-option.md) au lieu de <xref:System.Reflection.AssemblyDelaySignAttribute>.  
...
- [Page de signature, Concepteur de projet](/visualstudio/ide/reference/signing-page-project-designer)

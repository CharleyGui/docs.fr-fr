...
- [-keyfile (C# options du compilateur)](../compiler-options/keyfile-compiler-option.md) au lieu de l’attribut <xref:System.Reflection.AssemblyKeyFileAttribute>.  
  
- [-keycontainer (C# options du compilateur)](../compiler-options/keycontainer-compiler-option.md) au lieu de <xref:System.Reflection.AssemblyKeyNameAttribute>.  
  
- [-delaysign (C# options du compilateur)](../compiler-options/delaysign-compiler-option.md) au lieu de <xref:System.Reflection.AssemblyDelaySignAttribute>.  

...
---
# <a name="compiler-error-cs0731"></a>Erreur du compilateur CS0731

Le redirecteur de type pour le type 'type' dans l’assembly 'assembly' provoque un cycle  
  
 Cette erreur peut se produire uniquement avec les métadonnées importées et incorrectement formées. Elle ne peut pas se produire avec seulement la source C#.  
  
## <a name="example"></a>Exemple  

 L’exemple suivant génère l’erreur CS0731. Cet exemple est constitué de trois fichiers :  
 ...
 En premier lieu compilez les fichiers .IL comme bibliothèques, puis compilez le code .cs qui référence les deux fichiers.  

---
description: Erreur du compilateur CS0015
...
ms.locfileid: "89122405"
---
# <a name="compiler-error-cs0015"></a><span data-ttu-id="2238c-103">Erreur du compilateur CS0015</span><span class="sxs-lookup"><span data-stu-id="2238c-103">Compiler Error CS0015</span></span>

<span data-ttu-id="2238c-104">Le nom du type 'type' est trop long</span><span class="sxs-lookup"><span data-stu-id="2238c-104">The name of type 'type' is too long</span></span>

 <span data-ttu-id="2238c-105">Le nom complet d’un type défini par l’utilisateur doit comprendre moins de 1024 caractères, dont les points.</span><span class="sxs-lookup"><span data-stu-id="2238c-105">The fully qualified name of a user-defined type must have fewer than 1024 characters, including the periods.</span></span>

 <span data-ttu-id="2238c-106">L’exemple suivant génère l’erreur CS0015 :</span><span class="sxs-lookup"><span data-stu-id="2238c-106">The following sample generates CS0015:</span></span>

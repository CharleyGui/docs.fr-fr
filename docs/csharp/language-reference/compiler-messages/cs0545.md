...
- Masquez la propriété de la classe de base par ajout du mot clé [new](../../../csharp/language-reference/keywords/new-modifier.md) à une propriété de classe dérivée.  

...
Le type TypeName1 existe dans TypeName2 et dans TypeName3  
 ...
 Pour résoudre cette erreur, utilisez la fonctionnalité d’alias de l’option de compilateur [-Reference (C# options du compilateur)](../compiler-options/reference-compiler-option.md) ou ne référencez pas l’un de vos assemblys.  

...
Une conversion avec l’opérateur [as](../../language-reference/operators/type-testing-and-conversion-operators.md#as-operator) est autorisée par héritage, conversions de référence et conversions boxing.

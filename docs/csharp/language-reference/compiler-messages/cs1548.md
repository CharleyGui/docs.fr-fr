...
Échec de chiffrement pendant la signature de l’assembly 'assembly' — 'reason'  
 ...
 Pour plus d’informations, consultez [Comment : signer un assembly avec un nom fort](../../../standard/assembly/sign-strong-name.md), [-keyfileC# (options du compilateur)](../compiler-options/keyfile-compiler-option.md) et [-C# delaysign (options du compilateur)](../compiler-options/delaysign-compiler-option.md).  

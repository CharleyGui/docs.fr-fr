...
Pour plus d’informations sur les paramètres de rejet lambda, consultez la [Remarque relative](~/_csharplang/proposals/csharp-9.0/lambda-discard-parameters.md) à la proposition de fonctionnalité.

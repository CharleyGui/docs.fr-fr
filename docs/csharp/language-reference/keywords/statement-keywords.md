...
|Instructions de saut|[break](break.md), [continue](continue.md), [default](switch.md), [goto](goto.md), [return](return.md), [yield](yield.md)|
|Instructions de gestion des exceptions|[throw](throw.md), [try-catch](try-catch.md), [try-finally](try-finally.md), [try-catch-finally](try-catch-finally.md)|
|[Checked et unchecked](checked-and-unchecked.md)|[checked](checked.md), [unchecked](unchecked.md)|
[fixed, instruction](fixed-statement.md)|[fixed](fixed-statement.md)|
|[lock, instruction](lock-statement.md)|[lock](lock-statement.md)|

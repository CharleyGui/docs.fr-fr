...
|||||  
|---|---|---|---|  
|[abstract](abstract.md)|[en tant que](../operators/type-testing-and-cast.md#as-operator)|[base](base.md)|[bool](../builtin-types/bool.md)|  
...
|[set](set.md)|[non managé (contrainte de type générique)](../../programming-guide/generics/constraints-on-type-parameters.md#unmanaged-constraint)|[value](value.md)|
|[var](var.md)|[when (condition de filtre)](when.md)|[where (contrainte de type générique)](where-generic-type-constraint.md)|
|[where (clause de requête)](where-clause.md)|[with](../operators/with-expression.md)|[yield](yield.md)|

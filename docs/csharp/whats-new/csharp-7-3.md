...
- <span data-ttu-id="e9e73-115">Vous pouvez tester `==` et `!=` avec des types de tuple.</span><span class="sxs-lookup"><span data-stu-id="e9e73-115">You can test `==` and `!=` with tuple types.</span></span>

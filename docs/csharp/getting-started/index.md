...
- [Présentation du C# langage et du .NET Framework](introduction-to-the-csharp-language-and-the-net-framework.md)

     Fournit une vue d’ensemble du langage C# et de .NET.

- [Créer une C# application Hello World avec .net core dans Visual Studio](../../core/tutorials/with-visual-studio.md)
...
- [Créer une bibliothèque de classes C# avec et .NET standard dans Visual Studio](../../core/tutorials/library-with-visual-studio.md)

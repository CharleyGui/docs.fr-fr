...
ms.locfileid: "75713918"
---
# <a name="get-started-with-c"></a>Bien démarrer avec C\#

Cette section fournit des didacticiels courts et simples qui permettent de créer rapidement une application avec C# et .NET Core. Il ya des sujets de démarrage pour Visual Studio et Visual Studio Code. Ces articles supposent une expérience en programmation. Si vous êtes novice en programmation, essayez nos tutoriels interactifs de [présentation de C#](../tutorials/intro-to-csharp/index.md).

Les rubriques suivantes sont disponibles :

- [Introduction à la langue C et au cadre .NET](introduction-to-the-csharp-language-and-the-net-framework.md)

     Fournit une vue d’ensemble du langage C# et de .NET.

- [Créez une application C Hello World avec .NET Core dans Visual Studio](../../core/tutorials/with-visual-studio.md)
   ...
   Le sujet vous permet de créer et d’exécuter une simple application Hello World, puis de la modifier pour exécuter une application Hello World un peu plus interactive. Une fois que vous aurez terminé la création et l’exécution de votre application, vous pourrez également apprendre à [la déboguer](../../core/tutorials/debugging-with-visual-studio.md) et [la publier](../../core/tutorials/publishing-with-visual-studio.md) afin qu’elle puisse s’exécuter sur n’importe quelle plateforme prise en charge par .NET Core.

- [Créer une bibliothèque de classe avec C et .NET Standard dans Visual Studio](../../core/tutorials/library-with-visual-studio.md)
...
- [Lancez-vous avec le code de studio de C et visual](../../core/tutorials/with-visual-studio-code.md)

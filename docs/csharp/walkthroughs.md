...
ms.locfileid: "77626358"
---
# <a name="c-walkthroughs"></a>C#procédures
...
- [Création d’un composant Windows Runtime C# dans ou Visual Basic et son appel à partir de JavaScript](/windows/uwp/winrt-components/walkthrough-creating-a-simple-windows-runtime-component-and-calling-it-from-javascript)\
...
- [Création et utilisation d’objets dynamiquesC# (et Visual Basic)](./programming-guide/types/walkthrough-creating-and-using-dynamic-objects.md)\
...
- [Création d’un contrôle composite à C# l’aide de Visual](../framework/winforms/controls/walkthrough-authoring-a-composite-control-with-visual-csharp.md)\
...
- [Héritage à partir d’un contrôle Windows Forms avec C# Visual](../framework/winforms/controls/walkthrough-inheriting-from-a-windows-forms-control-with-visual-csharp.md)\
...
- [Débogage des contrôles de Windows Forms personnalisés au moment du Design](../framework/winforms/controls/walkthrough-debugging-custom-windows-forms-controls-at-design-time.md)\
...
- [Écriture de requêtes C# en (LINQ)](./programming-guide/concepts/linq/walkthrough-writing-queries-linq.md)\
...
- [Modèle objet simple et Query (C#) (LINQ to SQL)](../framework/data/adonet/sql/linq/walkthrough-simple-object-model-and-query-csharp.md)\
  Montre comment créer une classe d'entité et une requête simple pour filtrer la classe d'entité.

- [Utilisation des procédures stockées uniquementC#() (LINQ to SQL)](../framework/data/adonet/sql/linq/walkthrough-using-only-stored-procedures-csharp.md)\
...
- [Écriture d’un visualiseur C# dans](/visualstudio/debugger/walkthrough-writing-a-visualizer-in-csharp)\

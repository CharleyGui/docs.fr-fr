...
Ensuite, nous créons une instance de la classe `Vegetable` nommée `item` en utilisant le mot clé [`new` ](../../language-reference/keywords/new-operator.md) et en ajoutant un nom pour le constructeur `Vegetable` :

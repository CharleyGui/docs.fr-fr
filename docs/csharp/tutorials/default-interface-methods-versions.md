...
---
# <a name="tutorial-update-interfaces-with-default-interface-methods-in-c-80"></a>Didacticiel : mettre à jour les interfaces avec les méthodes d’interface par défaut en C# 8,0

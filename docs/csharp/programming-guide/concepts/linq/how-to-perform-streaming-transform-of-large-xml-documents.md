...
---
# <a name="how-to-perform-streaming-transform-of-large-xml-documents-c"></a>Comment effectuer une transformation de diffusion en continu de documents XML volumineux (C#)
...
## <a name="example"></a>Exemple  
 L’exemple suivant repose sur l’exemple de [diffusion en continu de fragments XML avec accès aux informations d’en-tête (C#)](./how-to-stream-xml-fragments-with-access-to-header-information.md).
...
## <a name="example"></a>Exemple  
L’exemple suivant s’appuie également sur l’exemple dans [Comment diffuser en continu des fragments XML avec accès aux informations d’en-tête (C#)](./how-to-stream-xml-fragments-with-access-to-header-information.md).

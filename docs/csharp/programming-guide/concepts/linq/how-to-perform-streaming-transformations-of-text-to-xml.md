...
---
# <a name="how-to-perform-streaming-transformations-of-text-to-xml-c"></a>Comment effectuer des transformations de diffusion en continu de texteC#au format XML ()

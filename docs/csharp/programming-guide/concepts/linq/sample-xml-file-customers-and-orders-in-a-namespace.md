...
description: Ce fichier XML est utilisé dans différents exemples de la documentation de LINQ to XML. Le fichier contient des clients et des commandes. Le code XML se trouve dans un espace de noms.
ms.date: 07/20/2015
...
ms.locfileid: "87302540"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace"></a><span data-ttu-id="a1aff-105">Exemple de fichier XML : Clients et commandes dans un espace de noms</span><span class="sxs-lookup"><span data-stu-id="a1aff-105">Sample XML File: Customers and Orders in a Namespace</span></span>
<span data-ttu-id="a1aff-106">Le fichier XML suivant est utilisé dans différents exemples dans la documentation [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)].</span><span class="sxs-lookup"><span data-stu-id="a1aff-106">The following XML file is used in various examples in the [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] documentation.</span></span> <span data-ttu-id="a1aff-107">Ce fichier contient des clients et des commandes.</span><span class="sxs-lookup"><span data-stu-id="a1aff-107">This file contains customers and orders.</span></span> <span data-ttu-id="a1aff-108">Le code XML se trouve dans un espace de noms.</span><span class="sxs-lookup"><span data-stu-id="a1aff-108">The XML is in a namespace.</span></span>  
  
## <a name="customersordersinnamespacexml"></a><span data-ttu-id="a1aff-109">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="a1aff-109">CustomersOrdersInNamespace.xml</span></span>  

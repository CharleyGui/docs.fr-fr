...
- [Comment : créer un groupe imbriqué](../../../linq/create-a-nested-group.md)
- [Guide pratique pour regrouper des fichiers par extension (LINQ) (C#)](./how-to-group-files-by-extension-linq.md)
- [Comment : regrouper les résultats d’une requête](../../../linq/group-query-results.md)
- [Guide pratique pour effectuer une sous-requête sur une opération de regroupement](../../../linq/perform-a-subquery-on-a-grouping-operation.md)

...
Pour obtenir un tutoriel plus détaillé sur le chaînage de requêtes, consultez [Tutoriel : Chaînage de requêtes](./deferred-execution-and-lazy-evaluation-in-linq-to-xml.md).

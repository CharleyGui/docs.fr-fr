...
---
# <a name="how-to-find-a-list-of-child-elements-xpath-linq-to-xml-c"></a>Comment trouver une liste d’éléments pour enfants (XPath-LINQ à XML) (C)
Ce sujet compare l’axe des [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] <xref:System.Xml.Linq.XContainer.Elements%2A> éléments de l’enfant XPath à l’axe.  

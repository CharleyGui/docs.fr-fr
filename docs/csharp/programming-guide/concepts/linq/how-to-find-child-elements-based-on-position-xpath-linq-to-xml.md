...
---
# <a name="how-to-find-child-elements-based-on-position-xpath-linq-to-xml-c"></a>Comment rechercher des éléments enfants en fonction de leur position (XPath-LINQ to XMLC#) ()

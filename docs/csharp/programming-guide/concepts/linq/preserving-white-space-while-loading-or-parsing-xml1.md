...
description: Découvrez comment contrôler le comportement de l’espace blanc lors du chargement ou de l’analyse de XML, en particulier le comportement des méthodes qui remplissent des arborescences XML.
ms.date: 07/20/2015

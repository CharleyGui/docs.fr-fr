---
title: Comment trouver des frères et sœurs précédents (XPath-LINQ à XML) (C)
ms.date: 07/20/2015
...
---
# <a name="how-to-find-preceding-siblings-xpath-linq-to-xml-c"></a>Comment trouver des frères et sœurs précédents (XPath-LINQ à XML) (C)

...
---
# <a name="in-memory-xml-tree-modification-vs-functional-construction-linq-to-xml-c"></a>Modification de l’arborescence XML en mémoire et construction fonctionnelle (LINQ to XML) (C#)

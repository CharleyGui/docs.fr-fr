...
## <a name="example"></a>Exemple  
 ...
 Cet exemple utilise le document XML suivant : [Exemple de fichier XML : Commandes fournisseur consolidées](../../../../csharp/programming-guide/concepts/linq/sample-xml-file-consolidated-purchase-orders.md).  

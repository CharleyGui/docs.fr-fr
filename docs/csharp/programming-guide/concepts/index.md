...
|[Collections (C#)](./collections.md)|Décrit quelques-uns des types de collections fournis par .NET. Montre comment utiliser des collections simples et des collections de paires clé/valeur.|  

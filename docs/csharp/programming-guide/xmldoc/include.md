...
---
# <a name="include-c-programming-guide"></a>\<inclure> (guide de programmation de CMD)
...
Cet exemple comprend plusieurs fichiers. Ce qui suit est le \<premier fichier, qui utilise comprennent>.

...
|[Guide de programmation C#](../index.md)|Fournit des liens vers des informations détaillées sur les fonctionnalités et fonctionnalités importantes du langage C# qui sont disponibles pour C# via .NET.|  

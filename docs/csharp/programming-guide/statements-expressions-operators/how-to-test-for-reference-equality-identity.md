---
title: Comment tester l’égalité de référence (identité) - Guide de programmation C
ms.date: 07/20/2015
helpviewer_keywords:
- object identity [C#]
...
---
# <a name="how-to-test-for-reference-equality-identity-c-programming-guide"></a>Comment tester l’égalité de référence (identité) (Guide de programmation de C)

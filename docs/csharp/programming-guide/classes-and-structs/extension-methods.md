...
```  
 ...
 Pour plus d’informations, consultez [Guide pratique pour Implémenter et appeler une méthode d’extension personnalisée](./how-to-implement-and-call-a-custom-extension-method.md).  

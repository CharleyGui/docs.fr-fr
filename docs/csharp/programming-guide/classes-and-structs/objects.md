...
## <a name="struct-instances-vs-class-instances"></a>Struct Instances vs Instances de classe  
...
## <a name="object-identity-vs-value-equality"></a>Identité d’objet vs égalité de valeur  
...
- [Objet](../../language-reference/builtin-types/reference-types.md)

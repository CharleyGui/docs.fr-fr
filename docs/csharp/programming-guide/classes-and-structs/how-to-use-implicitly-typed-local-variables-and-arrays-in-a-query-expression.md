...
---
# <a name="how-to-use-implicitly-typed-local-variables-and-arrays-in-a-query-expression-c-programming-guide"></a>Comment utiliser des variables et des tableaux locaux dactylographiés implicitement dans une expression de requête (Guide de programmation C)

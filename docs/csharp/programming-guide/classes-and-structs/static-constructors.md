...
- Si vous ne fournissez pas de constructeur statique pour initialiser les champs statiques, tous les champs statiques sont initialisés à leur valeur par défaut, comme indiqué dans les [valeurs par défaut des types C#](../../language-reference/builtin-types/default-values.md).
...
- [Avertissement de sécurité-CA2121 : les constructeurs statiques doivent être privés](/visualstudio/code-quality/ca2121-static-constructors-should-be-private)

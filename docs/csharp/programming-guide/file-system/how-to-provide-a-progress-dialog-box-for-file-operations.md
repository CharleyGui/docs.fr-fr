...
---
# <a name="how-to-provide-a-progress-dialog-box-for-file-operations-c-programming-guide"></a>Comment fournir une boîte de dialogue de progrès pour les opérations de fichiers (Guide de programmation C)

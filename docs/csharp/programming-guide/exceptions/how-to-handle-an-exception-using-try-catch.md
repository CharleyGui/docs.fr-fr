---
title: Comment gérer une exception à l’aide du Guide de C# programmation try-catch
ms.custom: seodec18
ms.date: 07/20/2015
helpviewer_keywords:
...
ms.locfileid: "75346249"
---
# <a name="how-to-handle-an-exception-using-trycatch-c-programming-guide"></a>Comment gérer une exception à l’aide de try/C# catch (Guide de programmation)

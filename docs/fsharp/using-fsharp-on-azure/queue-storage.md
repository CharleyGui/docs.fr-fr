...
La classe `CloudQueueClient` vous permet de récupérer des files d’attente stockées dans le stockage de files d’attente. Voici un moyen de créer le client du service :

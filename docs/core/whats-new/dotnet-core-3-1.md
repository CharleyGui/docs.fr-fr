...
Pour ajouter la prise en charge de C++/CLI dans Visual Studio 2019 version 16,4, installez la [charge de travail développement Desktop en c++](/cpp/build/vscpp-step-0-installation?view=vs-2019#step-4---choose-workloads). Cette charge de travail ajoute deux modèles à Visual Studio :

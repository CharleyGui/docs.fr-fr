...
- Le `dotnet` [conducteur](tools/index.md#driver).
...
Par défaut, le SDK s’installe de manière « côte à côte » (SxS), ce qui signifie que plusieurs versions peuvent coexister à tout moment sur une seule machine. Pour plus d’informations sur la façon dont la version est choisie lorsque vous exécutez des commandes CLI, consultez l’article [Sélectionner la version .NET Core à utiliser](versions/selection.md).

## <a name="see-also"></a>Voir aussi

- [vue d’ensemble CLI de base de .NET](tools/index.md)

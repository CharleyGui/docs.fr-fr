...
_Les installations de gestionnaire de paquets ne sont prises en charge que sur l’architecture **x64.** _ D’autres architectures, telles que **ARM**, doivent [installer manuellement le .NET Core SDK](../sdk.md?pivots=os-linux#download-and-manually-install) ou [installer manuellement le .NET Core Runtime](../runtime.md?pivots=os-linux#download-and-manually-install). Pour plus d’informations, voir [.NET Core dépendances et exigences](../dependencies.md).

...
---
# <a name="ubuntu-2004-package-manager---install-net-core"></a>Gestionnaire de package Ubuntu 20,04-installer .NET Core

[!INCLUDE [package-manager-switcher](./includes/package-manager-switcher.md)]

Cet article explique comment utiliser un gestionnaire de package pour installer .NET Core sur Ubuntu 20,04.

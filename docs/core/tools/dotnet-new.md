...
| <span data-ttu-id="e061c-212">:::no-loc(Blazor)::: Application serveur</span><span class="sxs-lookup"><span data-stu-id="e061c-212">:::no-loc(Blazor)::: Server App</span></span>                            | [<span data-ttu-id="e061c-213">blazorserver</span><span class="sxs-lookup"><span data-stu-id="e061c-213">blazorserver</span></span>](#blazorserver)   | <span data-ttu-id="e061c-214">[C#]</span><span class="sxs-lookup"><span data-stu-id="e061c-214">[C#]</span></span>         | <span data-ttu-id="e061c-215">Internet:::no-loc(Blazor):::</span><span class="sxs-lookup"><span data-stu-id="e061c-215">Web/:::no-loc(Blazor):::</span></span>                            | <span data-ttu-id="e061c-216">3.0</span><span class="sxs-lookup"><span data-stu-id="e061c-216">3.0</span></span>        |
| <span data-ttu-id="e061c-217">:::no-loc(Blazor)::::::no-loc(WebAssembly):::Application</span><span class="sxs-lookup"><span data-stu-id="e061c-217">:::no-loc(Blazor)::: :::no-loc(WebAssembly)::: App</span></span>                       | [<span data-ttu-id="e061c-218">blazorwasm</span><span class="sxs-lookup"><span data-stu-id="e061c-218">blazorwasm</span></span>](#blazorwasm)       | <span data-ttu-id="e061c-219">[C#]</span><span class="sxs-lookup"><span data-stu-id="e061c-219">[C#]</span></span>         | <span data-ttu-id="e061c-220">Internet:::no-loc(Blazor):::/:::no-loc(WebAssembly):::</span><span class="sxs-lookup"><span data-stu-id="e061c-220">Web/:::no-loc(Blazor):::/:::no-loc(WebAssembly):::</span></span>                | <span data-ttu-id="e061c-221">3.1.300</span><span class="sxs-lookup"><span data-stu-id="e061c-221">3.1.300</span></span>    |
...
- **`-ho|--hosted`**
  ...
  <span data-ttu-id="e061c-477">Comprend un hôte de ASP.NET Core pour l' :::no-loc(Blazor)::: :::no-loc(WebAssembly)::: application.</span><span class="sxs-lookup"><span data-stu-id="e061c-477">Includes an ASP.NET Core host for the :::no-loc(Blazor)::: :::no-loc(WebAssembly)::: app.</span></span>

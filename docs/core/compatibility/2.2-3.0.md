...
---
# <a name="breaking-changes-for-migration-from-version-22-to-30"></a>Modifications de rupture pour la migration de la version 2.2 à 3.0

Si vous migrez de la version 2.2 à la version 3.0 de .NET Core, ASP.NET Core, ou EF Core, les modifications de rupture énumérées dans cet article peuvent affecter votre application.

...
Si cette modification s’interrompt, vous pouvez utiliser un [convertisseur personnalisé](../../../../standard/serialization/system-text-json-converters-how-to.md) qui implémente la sémantique souhaitée.

 ...
 **Figure 7-11**. Exemple de tableau de bord présentant les informations de journalisation et de métrique de nombreux conteneurs en cours d’exécution.

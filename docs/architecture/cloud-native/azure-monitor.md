...
![Azure Monitor, une collection d’outils pour fournir un aperçu du fonctionnement d’une application Cloud native. ](./media/azure-monitor.png)
...
![Résultat de la Application Insights de la requête de la ](./media/azure-monitor.png)
 **figure 7-13**. Résultat de la requête de Application Insights.
...
![Voici un exemple de Application Insights graphiques incorporés dans le tableau de bord principal Azure ](./media/azure-monitor.png)
...
![Exemple Power BI la ](./media/azure-monitor.png)

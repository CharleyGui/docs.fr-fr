...
Il existe un [terrain pour expérimenter les requêtes Kusto](https://dataexplorer.azure.com/clusters/help/databases/Samples) . La lecture des [exemples de requêtes](https://docs.microsoft.com/azure/kusto/query/samples) peut également être instructive.

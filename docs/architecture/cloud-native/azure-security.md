...
Des rôles intégrés plus granulaires, tels que le [contributeur de zone DNS](/azure/role-based-access-control/built-in-roles#dns-zone-contributor) , disposent de droits limités à un seul service. Les principaux de sécurité peuvent prendre un nombre quelconque de rôles.

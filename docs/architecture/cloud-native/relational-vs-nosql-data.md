---
title: Données relationnelles et données NoSQL
...
ms.locfileid: "76794918"
---
# <a name="relational-vs-nosql-data"></a>Données relationnelles et données NoSQL
...
Les microservices qui utilisent le stockage table Azure peuvent facilement migrer vers le API Table Cosmos DB. Aucune modification de code n’est requise.
...
>[Précédent](Database-per-microservice.md)

...
Chacune des procédures pas à pas suivantes utilise les nouveaux exemples d’applications eShopLegacy et eShopModernizing, qui sont disponibles sur GitHub à <https://github.com/dotnet-architecture/eShopModernizing>.

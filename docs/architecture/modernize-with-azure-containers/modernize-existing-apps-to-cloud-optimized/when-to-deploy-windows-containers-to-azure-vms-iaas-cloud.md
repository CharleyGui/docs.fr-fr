...
- **Besoins en matière d’évolutivité petite et moyenne**: Dans les scénarios où vous pouvez avoir besoin de quelques machines virtuelles pour votre environnement de production, la gestion d’un petit nombre de machines virtuelles peut être abordable jusqu’à ce que vous puissiez passer à des environnements PaaS plus avancés, comme les orchestrateurs.

...
<span data-ttu-id="ff232-115">**Figure 4-12.**</span><span class="sxs-lookup"><span data-stu-id="ff232-115">**Figure 4-12.**</span></span> <span data-ttu-id="ff232-116">Azure DevOps Services pipeline de déploiement continu, déploiement sur un cluster Kubernetes</span><span class="sxs-lookup"><span data-stu-id="ff232-116">Azure DevOps Services continuous deployment pipeline, deploying to a Kubernetes cluster</span></span>

>[!div class="step-by-step"]
><span data-ttu-id="ff232-117">[Précédent](modernize-your-apps-with-monitoring-and-telemetry.md) 
> [Suivant](migrate-to-hybrid-cloud-scenarios.md)</span><span class="sxs-lookup"><span data-stu-id="ff232-117">[Previous](modernize-your-apps-with-monitoring-and-telemetry.md)

...
## <a name="issues-with-the-original-httpclient-class-available-in-net"></a>Problèmes avec la classe HttpClient d’origine disponible dans .NET
...
- **Utilisation de HttpClientFactory dans .NET**  

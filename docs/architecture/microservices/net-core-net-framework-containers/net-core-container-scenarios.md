...
En plus des IDE et des éditeurs, vous pouvez utiliser les outils de [l’interface CLI .NET Core](../../../core/tools/index.md) pour toutes les plateformes prises en charge.

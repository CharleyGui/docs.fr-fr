...
**Image multi-arch**: pour l’architecture mutualisée, est une fonctionnalité qui simplifie la sélection de l’image appropriée, en fonction de la plateforme sur laquelle s’exécute l’ordinateur, par exemple, lorsqu’un fichier dockerfile demande une image **de base de MCR.Microsoft.com/dotnet/Core/SDK :2.2** à partir du Registre, il obtient en fait **2,2-SDK-** -1709, **2,2-SDK-Server-1803**, **2,2-SDK-Server-1809** ou **2,2-SDK-Stretch**, selon le système d’exploitation et la version de l’ordinateur .

...
![Diagramme montrant les endroits où les conteneurs Docker peuvent fonctionner.](./media/docker-defined/docker-containers-run-anywhere.png)

**Figure 2-2**. Docker déploie des conteneurs à toutes les couches du nuage hybride.
...
| -----------------| ------------------|
|![Diagramme montrant la pile matérielle/logicielle d’un VM traditionnel.](./media/docker-defined/virtual-machine-hardware-software.png)|![Diagramme montrant la pile matérielle/logicielle pour les conteneurs Docker.](./media/docker-defined/docker-container-hardware-software.png)|

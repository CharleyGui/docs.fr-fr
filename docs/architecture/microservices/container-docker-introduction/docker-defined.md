...
| -----------------| ------------------|
|![Pour les machines virtuelles, il existe trois couches de base dans le serveur hôte, de bas en haut : infrastructure, système d’exploitation hôte et un hyperviseur, et par-dessus chaque machine virtuelle a son propre système d’exploitation et toutes les bibliothèques nécessaires.](./media/image3.png)|![Pour l’arrimeur, le serveur hôte dispose uniquement de l’infrastructure et du système d’exploitation et, en plus de cela, du moteur de conteneur, qui garde le conteneur isolé mais partage les services du système d’exploitation de base.](./media/image4.png)|

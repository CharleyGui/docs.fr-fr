...
## <a name="software-as-a-service-saas"></a>Logiciel en tant que service (SaaS)
...
En savoir plus sur SaaS à l’aide d’un [exemple d’application](https://docs.microsoft.com/azure/sql-database/saas-tenancy-welcome-wingtip-tickets-app).

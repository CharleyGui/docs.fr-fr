...
Bienvenue dans la documentation sur les nouveautés de .NET pour le 2020 avril. Cet article répertorie quelques-unes des principales modifications apportées à la documentation pendant cette période.
...
- [Configuration](../architecture/blazor-for-web-forms-developers/config.md) de l’application : configuration livre électronique éblouissante
...
- [Historique de C\# ](../csharp/whats-new/csharp-version-history.md) -ajouter des descriptions de version de langue récentes
...
- [Documentation de Windows Presentation Foundation (WPF) pour .net Core](../desktop-wpf/index.yml) -ajouter une page d’accueil pour Desktop WPF
...
- [Améliorations de l’accessibilité dans les contrôles de Windows Forms pour .net Core 3,0](../framework/winforms/windows-forms-accessibility-improvements.md) -ajout d’un document d’accessibilité pour le WinForms principal
...
- [Documentation .net](../standard/index.yml) -nouvelle page d’accueil pour/d’TOC

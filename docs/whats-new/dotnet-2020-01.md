...
- [Gestionnaire de package Ubuntu 19,10-installer .net Core](../core/install/linux-package-manager-ubuntu-1910.md) -ajouter Ubuntu 19,10
...
- [vue d’ensemble de Global. JSON](../core/tools/global-json.md) -mettre à jour global. json pour 3,0
...
- [ \< Résumé> (Guide de programmation C#)](../csharp/programming-guide/xmldoc/summary.md) -mettre à jour les commentaires de documentation XML

## <a name="net-framework"></a>.NET Framework

### <a name="updated-articles"></a>Articles mis à jour

- [Guide de référence du fichier de configuration des directives Runtime (Rd. Xml)](../framework/net-native/runtime-directives-rd-xml-configuration-file-reference.md) -corriger la mise en forme de la documentation Rd. Xml
...
- [Comment migrer de Newtonsoft. JSON vers System. Text. JSON](../standard/serialization/system-text-json-migrate-from-newtonsoft-how-to.md) -nouvel article-migrer à partir de Newtonsoft. JSON

### <a name="updated-articles"></a>Articles mis à jour

- [Sérialisation binaire](../standard/serialization/binary-serialization.md) -améliorations de la sérialisation binaire
- [Comment sérialiser et désérialiser (marshaler et démarshaler) JSON dans .net](../standard/serialization/system-text-json-how-to.md) -nouvel article-migrer à partir de Newtonsoft. JSON

...
Cette règle est activée par défaut uniquement pour les projets ciblant .NET 5,0 ou une version ultérieure. Toutefois, vous pouvez l' [activer](#configurability) pour les projets qui ciblent d’autres infrastructures.

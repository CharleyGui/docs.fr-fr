...
Cette règle se déclenche lorsque les deux conditions suivantes peuvent être remplies pour un [Newtonsoft.Json.JsonSerializerSettings](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm) instanc :

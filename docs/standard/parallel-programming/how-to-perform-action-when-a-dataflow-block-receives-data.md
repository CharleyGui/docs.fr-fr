...
## <a name="example"></a> Exemple  
 ...
 Le résumé de section des types de délégués dans le document <xref:System.Threading.Tasks.Dataflow.ActionBlock%601> <xref:System.Threading.Tasks.Dataflow.TransformBlock%602> [Dataflow](../../../docs/standard/parallel-programming/dataflow-task-parallel-library.md) résume les types de délégués que vous pouvez fournir à , , et <xref:System.Threading.Tasks.Dataflow.TransformManyBlock%602> les objets. La table indique également si le type délégué fonctionne de façon synchrone ou asynchrone.  

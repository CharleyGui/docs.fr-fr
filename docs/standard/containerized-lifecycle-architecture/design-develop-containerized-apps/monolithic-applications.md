...
Pour savoir comment effectuer une opération « lift and shift » sur des applications monolithiques avec des conteneurs et comment moderniser vos applications, vous pouvez consulter cet autre guide Microsoft, [Moderniser des applications .NET existantes avec le cloud Azure et des conteneurs Windows](../../modernize-with-azure-and-containers/index.md), également disponible en téléchargement au format PDF à l’adresse suivante : <https://aka.ms/LiftAndShiftWithContainersEbook>.

...
* [Bien démarrer avec .NET Core](../core/get-started.md) fournit une vue d’ensemble des articles qui indiquent comment bien démarrer avec .NET Core sur différents systèmes d’exploitation et en utilisant différents outils.

...
- [Comment : effectuer une conversion entre des flux de .NET Framework et des flux de Windows Runtime](../../../docs/standard/io/how-to-convert-between-dotnet-streams-and-winrt-streams.md)  

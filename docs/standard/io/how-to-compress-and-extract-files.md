...
Les exemples suivants présentent certaines des opérations que vous pouvez effectuer avec des fichiers compressés. Ces exemples nécessitent l’ajout des packages NuGet suivants à votre projet :

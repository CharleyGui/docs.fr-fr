...
ms.locfileid: "80344087"
---
# <a name="net-guide"></a>Guide .NET

Le guide .NET fournit des informations sur .NET. Selon votre familiarité avec .NET, vous pouvez explorer différentes sections de ce guide et d’autres guides tels que [.NET Core](../core/index.yml) ou [.NET Framework](../framework/index.yml).

...
---
# <a name="how-to-disable-the-strong-name-bypass-feature"></a>Comment : Désactiver la fonction de contournement de nom fort
...
## <a name="disable-the-strong-name-bypass-feature-for-all-applications"></a>Désactiver la fonction de contournement de nom fort pour toutes les applications  
...
## <a name="disable-the-strong-name-bypass-feature-for-a-single-application"></a>Désactiver la fonction de contournement de nom fort pour une seule application  
  
1. Ouvrez ou créez le fichier de configuration de l’application.  
  
    Pour plus d’informations sur ce fichier, consultez la section Fichiers de configuration d’application dans [configurer les applications](../../framework/configure-apps/index.md).  
...
2. Ajoutez l’entrée suivante :  
 ...
 Vous pouvez restaurer la fonction de contournement de l’application `true`en supprimant le paramètre de fichiers de configuration ou en définissant l’attribut à .  

...
4. Vérifie la Global Assembly Cache, les codes base spécifiés dans les fichiers de configuration, puis vérifie le répertoire et les sous-répertoires de l’application à l’aide des règles de détection expliquées dans la [manière dont le runtime localise les assemblys](../../framework/deployment/how-the-runtime-locates-assemblies.md).  
 ...
 Pour plus d’informations sur la configuration des applications, consultez [configurer](../../../docs/framework/configure-apps/index.md)des applications. Pour plus d’informations sur la stratégie de liaison, consultez [Comment le runtime localise les assemblys](../../framework/deployment/how-the-runtime-locates-assemblies.md).  
...
### <a name="assembly-version-number"></a>Numéro de version de l’assembly  
 ...
 Pour plus d’informations sur la spécification des stratégies de liaison de version, consultez [configurer des applications](../../../docs/framework/configure-apps/index.md). Pour plus d’informations sur la façon dont le runtime utilise les informations de version pour rechercher un assembly particulier, consultez [Comment le runtime localise les assemblys](../../framework/deployment/how-the-runtime-locates-assemblies.md).  

...
## <a name="custom-support-for-xrefsystemdatetime-and-xrefsystemdatetimeoffset-in-xrefsystemtextjsonjsonserializer"></a>Prise en charge <xref:System.DateTime> personnalisée <xref:System.DateTimeOffset> pour et dans<xref:System.Text.Json.JsonSerializer>

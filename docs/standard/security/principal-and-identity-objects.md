...
- [Procédure : créer un objet WindowsPrincipal](how-to-create-a-windowsprincipal-object.md)
- [Procédure : créer des objets GenericPrincipal et GenericIdentity](how-to-create-genericprincipal-and-genericidentity-objects.md)

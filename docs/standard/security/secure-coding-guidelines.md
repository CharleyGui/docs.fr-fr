...
|[Sécurité basée sur les rôles](role-based-security.md)|Décrit en détail la sécurité basée sur les rôles .NET et fournit des instructions pour l’utiliser dans votre code.|

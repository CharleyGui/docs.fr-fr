...
> [!NOTE]
> En C#, vous substituez <xref:System.Object.Finalize%2A?displayProperty=nameWithType> en définissant un [destructeur](../../csharp/programming-guide/classes-and-structs/destructors.md).  

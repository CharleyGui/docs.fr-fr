...
---
# <a name="sample-xml-file-test-configuration-in-a-namespace-linq-to-xml"></a>Exemple de fichier XML : configuration de test dans un espace de noms (LINQ to XML)

Le fichier XML suivant est utilisé dans différents exemples de la documentation de LINQ to XML. Il s'agit d'un fichier de configuration test. Le code XML se trouve dans un espace de noms.

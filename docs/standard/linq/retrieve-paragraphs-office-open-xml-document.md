...
L’exemple ouvre un package Office Open XML et utilise les relations au sein du package pour rechercher le document et les parties de style. Il interroge ensuite le document et projette une collection qui contient les informations de paragraphe. Chaque objet de la collection représente un paragraphe et contient le nœud de paragraphe <xref:System.Xml.Linq.XElement> , le nom de style et le texte.

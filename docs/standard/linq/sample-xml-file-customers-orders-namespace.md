---
title: 'Exemple de fichier XML : clients et commandes dans un espace de noms-LINQ to XML'
description: Ce fichier XML, qui est utilisé dans les exemples, contient des données, dans un espace de noms, sur les clients et les commandes.
ms.date: 07/20/2015
...
ms.locfileid: "89553623"
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a><span data-ttu-id="c4918-103">Exemple de fichier XML : clients et commandes dans un espace de noms (LINQ to XML)</span><span class="sxs-lookup"><span data-stu-id="c4918-103">Sample XML file: Customers and orders in a namespace (LINQ to XML)</span></span>

<span data-ttu-id="c4918-104">Le fichier XML suivant est utilisé dans différents exemples de la documentation de LINQ to XML.</span><span class="sxs-lookup"><span data-stu-id="c4918-104">The following XML file is used in various examples in the LINQ to XML documentation.</span></span> <span data-ttu-id="c4918-105">Ce fichier contient des clients et des commandes.</span><span class="sxs-lookup"><span data-stu-id="c4918-105">This file contains customers and orders.</span></span> <span data-ttu-id="c4918-106">Le code XML se trouve dans un espace de noms.</span><span class="sxs-lookup"><span data-stu-id="c4918-106">The XML is in a namespace.</span></span>

## <a name="customersordersinnamespacexml"></a><span data-ttu-id="c4918-107">CustomersOrdersInNamespace.xml</span><span class="sxs-lookup"><span data-stu-id="c4918-107">CustomersOrdersInNamespace.xml</span></span>

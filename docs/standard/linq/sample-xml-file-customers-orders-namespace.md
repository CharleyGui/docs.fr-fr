...
---
# <a name="sample-xml-file-customers-and-orders-in-a-namespace-linq-to-xml"></a>Exemple de fichier XML : clients et commandes dans un espace de noms (LINQ to XML)

Le fichier XML suivant est utilisé dans différents exemples de la documentation de LINQ to XML. Ce fichier contient des clients et des commandes. Le code XML se trouve dans un espace de noms.

...
---
# <a name="sample-xml-file-multiple-purchase-orders-in-a-namespace-linq-to-xml"></a>Exemple de fichier XML : plusieurs commandes fournisseur dans un espace de noms (LINQ to XML)

Le fichier XML suivant est utilisé dans différents exemples de la documentation de LINQ to XML. Ce fichier contient plusieurs commandes fournisseur. Le code XML se trouve dans un espace de noms.

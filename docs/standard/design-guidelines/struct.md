 ...
 **X ne fournissent pas** de constructeur sans paramètre pour un struct.  
 ...
 **X DO NOT** prolonger explicitement <xref:System.ValueType>. En fait, la plupart des langues l’empêchent.  

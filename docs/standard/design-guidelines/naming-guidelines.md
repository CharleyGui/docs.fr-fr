...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Noms des espaces de noms](names-of-namespaces.md)  
 ...
 [Paramètres d’attribution de noms](naming-parameters.md)  
 [Attribution de noms aux ressources](naming-resources.md)  

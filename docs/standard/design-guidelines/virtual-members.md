 ...
 **✓ DO** accessibilité protégée préférer une accessibilité publique pour les membres virtuels. Les membres publics doivent fournir une extensibilité (si nécessaire) en appelant dans un membre virtuel protégé.  

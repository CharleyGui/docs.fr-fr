...
| Nom                     | Modificateur d’accès  | Type     | Nom de la propriété personnalisée | Prise en charge de la déconstruction | Prise en charge de l’arborescence d’expressions |
|--------------------------|-----------------|----------|----------------------|------------------------|-------------------------|
...
- [Instructions de conception de types](type.md)

...
> [!NOTE]
> Pour plus d’informations sur la pagination dans WCF Data Services [, consultez Procédure : Charger les résultats paginés (WCF Data Services](../data/wcf/how-to-load-paged-results-wcf-data-services.md)).

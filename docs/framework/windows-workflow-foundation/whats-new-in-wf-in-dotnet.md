...
>
> - C#les expressions seront remplacées dans le concepteur avec la **valeur de message définie en XAML**.
...
## <a name="BKMK_Versioning"></a>Contrôle de version de workflow

.NET Framework 4,5 a introduit plusieurs nouvelles fonctionnalités de contrôle de version basées sur la nouvelle classe <xref:System.Activities.WorkflowIdentity>. <xref:System.Activities.WorkflowIdentity> fournit aux auteurs d'applications de workflow un mécanisme pour mapper une instance de workflow persistante avec sa définition.
...
## <a name="BKMK_NewActivities"></a>ACTIVITE
...
### <a name="BKMK_NoPersistScope"></a>Étendue NoPersist
...
### <a name="BKMK_NewFlowchartCapabilities"></a>Nouvelles fonctionnalités d’organigramme
...
## <a name="BKMK_NewDesignerCapabilites"></a>Nouvelles fonctionnalités du concepteur
...
### <a name="BKMK_VariableDeleteContextMenu"></a>Supprimer l’élément de menu contextuel dans le concepteur de variables et d’arguments
...
### <a name="BKMK_AutoSurround"></a>Entourer automatiquement d’une séquence

Étant donné qu'un workflow ou certaines activités de conteneur (telles que <xref:System.Activities.Statements.NoPersistScope>) peuvent uniquement contenir une seule activité de corps, l'ajout d'une deuxième activité exigeait que le développeur supprime la première activité, ajoute une activité <xref:System.Activities.Statements.Sequence>, puis ajoute les deux activités à l'activité de séquence. À compter de .NET Framework 4,5, lors de l’ajout d’une deuxième activité à l’aire du concepteur, une activité de `Sequence` est automatiquement créée pour encapsuler les deux activités.
...
### <a name="BKMK_DocumentOutline"></a>vue Structure d’éléments de flux de travail
...
Pour plus d’informations C# sur les expressions, consultez [ C# expressions](csharp-expressions.md).

### <a name="BKMK_Visibility"></a>Contrôle accru de la visibilité de la barre de Shell et des éléments d’en-tête
...
### <a name="BKMK_AutoConnect"></a>Connexion automatique et insertion automatique dans un diagramme de flux de travail et des workflows d’ordinateur d’État
...
### <a name="BKMK_DesignTimeValidation"></a>Validation en arrière-plan au moment du design
...
### <a name="BKMK_BackwardCompatRehostedDesigner"></a>Abonnement pour les fonctionnalités de workflow 4,5 dans le concepteur réhébergé
...
Les workflows de machine à États ont été introduits dans le cadre de l' .NET Framework 4, version 4.0.1 dans la [mise à jour 1 de la plateforme Microsoft .NET Framework 4](https://go.microsoft.com/fwlink/?LinkID=215092). Cette mise à jour inclut plusieurs nouvelles classes et activités qui permettent aux développeurs de créer des workflow de machine à états. Ces classes et activités ont été mises à jour pour .NET Framework 4,5. Les mises à jour comprennent :

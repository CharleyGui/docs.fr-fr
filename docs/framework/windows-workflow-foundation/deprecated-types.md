...
Dans le .NET 4, l’équipe de workflow a mis à disposition un nouveau au moteur de workflow dans l’espace de noms <xref:System.Activities>. Avec la sortie de .NET 4,5 Beta, nous indiquons la plupart des types dans les espaces de noms « WF 3 » <xref:System.Workflow.Activities> , <xref:System.Workflow.ComponentModel> et  <xref:System.Workflow.Runtime> comme obsolètes.  

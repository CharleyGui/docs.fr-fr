...
## <a name="wf-migration-whitepapers-and-cookbooks"></a>Livres blancs et livres de recettes sur la migration WF (en anglais)  
 ...
 [Aide de WF : règles](https://go.microsoft.com/fwlink/?LinkId=153854)  
 Explique comment faire progresser les investissements liés aux règles dans .NET Framework 4 solutions.  
  
 [Aide WF : machine à États](https://go.microsoft.com/fwlink/?LinkId=153855)  
 ...
 [Aide de WF : Workflow Services](https://go.microsoft.com/fwlink/?LinkId=275564)  

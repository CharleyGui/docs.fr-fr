...
## <a name="in-this-section"></a>Dans cette section
 ...
 Montre comment créer des activités qui permettent d’accéder aux bases de données afin de récupérer ou de modifier des informations et d’utiliser [ADO.net](https://go.microsoft.com/fwlink/?LinkId=166081) pour accéder à la base de données.  

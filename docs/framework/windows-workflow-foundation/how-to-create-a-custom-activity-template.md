...
7. Sélectionnez **exécuter sans débogage** dans le menu **Déboguer** et appuyez sur n’importe quelle touche pour continuer quand vous y êtes invité dans la fenêtre cmd. exe.

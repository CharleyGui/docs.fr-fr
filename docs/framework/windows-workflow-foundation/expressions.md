...
> [!NOTE]
> La prise C# en charge des expressions dans les projets de workflow a été introduite dans .NET Framework 4,5. Pour plus d’informations, consultez [ C# expressions](csharp-expressions.md).
...
```
 ...
 Le même Workflow peut être exprimé plus compact en utilisant C# des expressions lambda, comme illustré dans l’exemple suivant :
...
```
 ...
 Pour plus d’informations sur l’utilisation d’expressions dans le code, consultez [création de flux de travail, d’activités et d’expressions à l’aide du code impératif](authoring-workflows-activities-and-expressions-using-imperative-code.md).

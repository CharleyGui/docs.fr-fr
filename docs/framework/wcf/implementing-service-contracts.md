...
- [Guide pratique pour créer un service avec une classe de contrat](./feature-details/how-to-create-a-wcf-contract-with-a-class.md)
- [Guide pratique pour créer un service avec une interface de contrat](./feature-details/how-to-create-a-service-with-a-contract-interface.md)

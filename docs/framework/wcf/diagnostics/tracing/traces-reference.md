...
ms.locfileid: "96293414"
---
# <a name="traces-reference"></a>Référence des suivis

Cette section répertorie tous les suivis générés par Windows Communication Foundation (WCF).  

...
- Journalisation des messages activée : Journalise les événements lorsque l’enregistrement des messages est activé. L'objectif consiste à avertir l'administrateur que des informations sensibles et spécifiques à l'application peuvent être journalisées dans les en-têtes et les corps des messages.  

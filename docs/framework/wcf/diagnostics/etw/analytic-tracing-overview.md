...
Pour plus d’informations sur ETW, consultez [améliorer le débogage et le réglage des performances avec ETW](https://docs.microsoft.com/archive/msdn-magazine/2007/april/event-tracing-improve-debugging-and-performance-tuning-with-etw).
...
Les diagnostics WCF sont activés dans la section de configuration `<system.serviceModel><diagnostics>`.

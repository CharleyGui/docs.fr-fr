...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Montre comment obtenir des informations à partir d’un client typé généré par l' [outil utilitaire de métadonnées ServiceModel (Svcutil.exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md).

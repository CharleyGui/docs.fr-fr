...
2. Ouvrez le fichier. svc du service et observez que sa directive @ServiceHost contient un attribut Factory qui spécifie le nom d’un ServiceHostFactory personnalisé.  

...
## <a name="demonstrates"></a>Illustre le  
 ...
 Pour exécuter l'exemple et générer les projets de client et de serveur. Ouvrez ensuite deux fenêtres de commande et remplacez les répertoires par les \<sample> \<sample> répertoires \CS\Service\bin\debug et \CS\Client\bin\debug. Démarrez ensuite le service en tapant `service.exe` , puis appelez le Client.exe avec la valeur initiale des graduations passée comme argument d’entrée. Le code suivant illustre le résultat pour 10 cycles.  

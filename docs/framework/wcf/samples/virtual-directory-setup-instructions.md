...
1. Ouvrez une fenêtre d’invite de commandes `start inetmgr` et tapez pour ouvrir le composant logiciel enfichable MMC Internet Information Services (IIS).  

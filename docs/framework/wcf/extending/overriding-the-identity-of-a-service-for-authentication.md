...
### <a name="using-the-identity-element-in-configuration"></a>Utilisation \<de l’identité> Element in Configuration  
...
### <a name="setting-identity-programmatically"></a>Définition de l'identité par programme  
 Votre service n’a pas à spécifier explicitement une identité, car WCF la détermine automatiquement. Toutefois, WCF vous permet de spécifier une identité sur un point de terminaison, si nécessaire. Le code suivant ajoute un point de terminaison de service avec une identité DNS spécifique.  

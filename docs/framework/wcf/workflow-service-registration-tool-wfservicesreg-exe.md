...
#### <a name="scriptmap-deleted-under-a-particular-web-site"></a>Mappage de scripts supprimé sous un site web particulier  
 ...
 Pour réparer des gestionnaires supprimés pour un site Web particulier, vous devez exécuter « WFServicesReg.exe/r » pour supprimer des gestionnaires de tous les sites Web, puis exécuter « WFServicesReg.exe/c » pour créer les gestionnaires appropriés pour tous les sites Web.  

...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit la correspondance entre les encodages JSON (JavaScript Object Notation) et le jeu d’informations XML, qui est utilisé en interne par Windows Communication Foundation (WCF) pour représenter des données et des documents encodés JSON.  

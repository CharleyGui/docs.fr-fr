...
Le scénario suivant montre un client et un service Windows Communication Foundation (WCF) sécurisés à l’aide du mode de sécurité message. Le client et le service sont tous les deux authentifiés à l'aide de certificats. Pour plus d’informations, consultez [sécurité des applications distribuées](../../../../docs/framework/wcf/feature-details/distributed-application-security.md).
 ...
 Pour obtenir un exemple d’application, consultez [certificat de sécurité de message](../../../../docs/framework/wcf/samples/message-security-certificate.md).  
...
### <a name="configuration"></a>Configuration  
 La configuration ci-dessous spécifie le certificat client à l'aide d'un comportement de point de terminaison. Pour plus d’informations sur les certificats, consultez [Utilisation de certificats](../../../../docs/framework/wcf/feature-details/working-with-certificates.md). Le code utilise également un élément <`identity`> pour spécifier un DNS (Domain Name System) de l’identité de serveur attendue. Pour plus d’informations sur l’identité, consultez [identité du service et authentification](../../../../docs/framework/wcf/feature-details/service-identity-and-authentication.md).  

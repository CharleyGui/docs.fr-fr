...
1. Exécutez l' [outil ServiceModel Metadata Utility (Svcutil.exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md) pour créer un client WCF pour le service Web WSE 3,0.  
...
2. Créez une classe qui représente une liaison pouvant communiquer avec les services Web WSE 3.0.  
     ...
     La classe suivante fait partie de l’exemple [interopérabilité avec WSE](/previous-versions/dotnet/netframework-3.5/ms752257(v=vs.90)) :  

...
- [Procédure : configurer des paramètres de service COM+](how-to-configure-com-service-settings.md)
- [Procédure : utiliser l’outil de configuration de modèle de service COM+](how-to-use-the-com-service-model-configuration-tool.md)

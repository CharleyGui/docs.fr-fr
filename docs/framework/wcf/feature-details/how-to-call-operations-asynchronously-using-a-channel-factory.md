...
1. Exécutez l’outil [ServiceModel Metadata Utility Tool (Svcutil. exe)](../servicemodel-metadata-utility-tool-svcutil-exe.md) avec l' `/async` option, comme indiqué dans la commande suivante.  

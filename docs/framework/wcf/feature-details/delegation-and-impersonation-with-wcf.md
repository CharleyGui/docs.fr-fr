...
## <a name="impersonation-for-all-service-methods"></a>Emprunt d'identité pour toutes les méthodes de service  
 ...
 Le tableau suivant décrit le comportement WCF pour toutes les combinaisons `ImpersonationOption` possibles `ImpersonateCallerForAllServiceOperations`de et.  

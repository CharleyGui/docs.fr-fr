...
- [Guide pratique pour Configurer le service WCF pour interagir avec les clients du service Web ASP.NET](../../../../docs/framework/wcf/feature-details/config-wcf-service-with-aspnet-web-service.md)

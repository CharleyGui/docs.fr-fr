...
```  
 ...
 Lorsque vous ajoutez des points de terminaison d’annonce, vous devez également ajouter un service d’écoute de l’annonce à l’élément < `services` > comme indiqué dans l’exemple suivant.  

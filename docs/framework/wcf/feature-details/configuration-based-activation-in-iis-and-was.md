...
> - L’attribut `relativeAddress` doit être défini sur une adresse relative telle que «\<sous-répertoire >/service.svc » ou « ~/\<Sub-Directory/Service. svc ».

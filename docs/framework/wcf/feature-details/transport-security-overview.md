...
#### <a name="basic"></a>Basic  
 Il s'agit de la méthode d'authentification de base dans IIS. Lorsque ce mode est utilisé, le serveur IIS doit être configuré avec des comptes utilisateur Windows et les autorisations de système de fichiers NTFS adéquates. Pour plus d’informations sur IIS 6,0, voir activation de l' [authentification de base et configuration du nom de domaine](/previous-versions/windows/it-pro/windows-server-2003/cc785293(v=ws.10)). Pour plus d’informations sur IIS 7,0, voir [configurer l’authentification de base (IIS 7)](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc772009(v=ws.10)).  
  
#### <a name="certificate"></a>Certificat  
 Sur les services IIS, une option permet de spécifier que les clients doivent se connecter en utilisant un certificat. Cette fonctionnalité permet également aux services IIS de mapper les certificats clients aux comptes Windows correspondants. Pour plus d’informations sur IIS 6,0, voir [activation de certificats clients dans iis 6,0](/previous-versions/windows/it-pro/windows-server-2003/cc727994(v=ws.10)). Pour plus d’informations sur IIS 7,0, voir [Configuration des certificats de serveur dans IIS 7](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732230(v=ws.10)).  
  
#### <a name="digest"></a>Digest  
 L'authentification Digest s'apparente à l'authentification de base tout en présentant l'avantage supplémentaire de permettre l'envoi des informations d'identification dans un texte haché plutôt qu'en texte clair. Pour plus d’informations sur IIS 6,0, consultez [authentification Digest dans iis 6,0](/previous-versions/windows/it-pro/windows-server-2003/cc782661(v=ws.10)). Pour plus d’informations sur IIS 7,0, consultez [configurer l’authentification Digest (IIS 7)](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc754104(v=ws.10)).  
  
#### <a name="windows"></a>Windows  
 Il s'agit de l'authentification Windows intégrée à IIS. Lorsque ce mode d'authentification est activé, le serveur doit également figurer dans un domaine Windows utilisant le protocole Kerberos comme contrôleur. Dans le cas contraire ou si le système Kerberos connaît une défaillance, vous pouvez utiliser l'authentification NT LAN Manager (NTLM), abordée dans la section suivante. Pour plus d’informations sur IIS 6,0, voir [authentification Windows intégrée dans iis 6,0](/previous-versions/windows/it-pro/windows-server-2003/cc738016(v=ws.10)). Pour plus d’informations sur IIS 7,0, voir [Configuration des certificats de serveur dans IIS 7](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732230(v=ws.10)).
  
#### <a name="ntlm"></a>NTLM  
 Cela permet au serveur d'utiliser NTLM pour l'authentification si le fournisseur Kerberos échoue. Pour plus d’informations sur la configuration d’IIS dans IIS 6,0, consultez la page [forcer l’authentification NTLM](/previous-versions/windows/it-pro/windows-server-2003/cc786486(v=ws.10)). Pour IIS 7,0, l’authentification Windows comprend l’authentification NTLM. Pour plus d'informations, consultez [Configuration des certificats de serveur dans IIS 7](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732230(v=ws.10)).

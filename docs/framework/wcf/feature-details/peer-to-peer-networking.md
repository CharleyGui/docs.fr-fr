...
## <a name="in-this-section"></a>Dans cette section  
 [Scénarios de canal homologue](peer-channel-scenarios.md): décrit les scénarios de développement pris en charge par les API canal homologue, telles que la messagerie de publication/abonnement, la collaboration, le traitement distribué et le jeu.  
  
 [Concepts de canal homologue](peer-channel-concepts.md): décrit les maillages d’homologues, les nœuds homologues, la sécurité des canal homologue et les programmes de résolution d’homologue.  
  
 [Génération d’une Application canal homologue](building-a-peer-channel-application.md): fournit des conseils sur le développement d’applications canal homologue.  
...
## <a name="peer-channel-team-blog"></a>Peer Channel Team Blog  
 [Blog de l’équipe canal homologue](https://docs.microsoft.com/archive/blogs/peerchan/)

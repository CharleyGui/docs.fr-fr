...
### <a name="use-of-dead-letter-queues"></a>Utilisation des files d'attente de lettres mortes  
 ...
 Pour plus d’informations, consultez [utilisation de Dead-Letter files d’attente pour gérer les échecs de transfert des messages](using-dead-letter-queues-to-handle-message-transfer-failures.md).  

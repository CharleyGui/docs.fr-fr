...
Windows Communication Foundation (WCF) vous permet de créer un service qui expose un point de terminaison compatible AJAX ASP.NET qui peut être appelé à partir de JavaScript sur un site Web client. Les procédures de base pour la création de ces services [sont décrites dans How to : Utilisez la configuration pour ajouter un point de](../../../../docs/framework/wcf/feature-details/how-to-use-configuration-to-add-an-aspnet-ajax-endpoint.md) terminaison [ASP.NET AJAX et comment : Ajoutez un point de terminaison AJAX ASP.NET sans](../../../../docs/framework/wcf/feature-details/how-to-add-an-aspnet-ajax-endpoint-without-using-configuration.md)utiliser la configuration.  
 ...
 Pour obtenir un exemple fonctionnel de basculement vers, consultez l’exemple [Basic AJAX Service](../../../../docs/framework/wcf/samples/basic-ajax-service.md) .  
  
 Pour obtenir un exemple qui utilise la publication, consultez l’exemple [service Ajax à l’aide du protocole http](../../../../docs/framework/wcf/samples/ajax-service-using-http-post.md) .  

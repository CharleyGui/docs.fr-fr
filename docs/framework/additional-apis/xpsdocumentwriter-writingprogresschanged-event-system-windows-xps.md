...
---
# <a name="xpsdocumentwriter_writingprogresschanged-event"></a>XpsDocumentWriter. Événement \_WritingProgressChanged

Se produit lorsque la <xref:System.Windows.Xps.XpsDocumentWriter> met à jour sa progression. 

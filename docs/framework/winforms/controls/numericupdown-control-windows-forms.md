...
## <a name="related-sections"></a>Sections connexes  
 ...
 Introduit un contrôle similaire à <xref:System.Windows.Forms.NumericUpDown>, à ceci près que le contrôle <xref:System.Windows.Forms.DomainUpDown> affiche une chaîne au lieu de valeurs numériques.

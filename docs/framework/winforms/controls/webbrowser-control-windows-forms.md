...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Montre comment utiliser le contrôle pour accéder à une URL spécifique.  
 ...
 Décrit comment initialiser le contrôle pour l’utiliser comme un navigateur Web.  
 ...
 Décrit comment initialiser le contrôle pour l’utiliser en tant que visionneuse HTML.  

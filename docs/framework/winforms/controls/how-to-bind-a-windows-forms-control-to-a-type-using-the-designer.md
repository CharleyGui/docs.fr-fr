...
3. Cliquez sur la flèche en regard <xref:System.Windows.Forms.TextBox.Text%2A> de la propriété.

4. Dans l **'éditeur de types d’interface utilisateur DataSource**, développez le nœud pour le <xref:System.Windows.Forms.BindingSource> ajouté précédemment, puis sélectionnez la propriété du type lié que vous souhaitez lier à <xref:System.Windows.Forms.TextBox>la <xref:System.Windows.Forms.TextBox.Text%2A> propriété de.

## <a name="see-also"></a>Voir aussi

- [BindingSource, composant](bindingsource-component.md)
- [Guide pratique pour Lier un contrôle Windows Forms à un type](how-to-bind-a-windows-forms-control-to-a-type.md)

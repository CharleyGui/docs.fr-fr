...
## <a name="related-sections"></a>Rubriques connexes  
 ...
 [Affichage sous forme d’info-bulles de l’aide relative aux contrôles](../advanced/control-help-using-tooltips.md)  
 Traite des info-bulles comme moyen de fournir de brefs messages d'aide pour des contrôles spécifiques dans les Windows Forms.

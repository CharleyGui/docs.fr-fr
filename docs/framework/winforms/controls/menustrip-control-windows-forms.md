...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment personnaliser un <xref:System.Windows.Forms.MenuStrip> en définissant les propriétés de marge d'image et de sélection de différentes manières.  

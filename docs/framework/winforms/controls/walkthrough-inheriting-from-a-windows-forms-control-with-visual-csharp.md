...
2. Sélectionnez le modèle de projet **bibliothèque de contrôles Windows Forms** dans la liste C# des projets visuels, `ValueButtonLib` puis tapez dans la zone **nom** .

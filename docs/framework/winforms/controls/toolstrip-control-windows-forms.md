...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Décrit comment utiliser la classe <xref:System.Windows.Forms.ToolStripProfessionalRenderer> pour créer un contrôle composite qui imite le **volet de navigation** fourni par Microsoft® Outlook®.  
...
- [Comment : créer un ToolStrip de base Windows Forms avec des éléments standard à l’aide du concepteur](create-a-basic-wf-toolstrip-with-standard-items-using-the-designer.md)  

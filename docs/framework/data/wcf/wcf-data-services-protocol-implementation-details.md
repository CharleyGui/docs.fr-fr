...
## <a name="wcf-data-services-behaviors"></a>Comportements des services de données WCF  
 Les comportements de [!INCLUDE[ssAstoria](../../../../includes/ssastoria-md.md)] suivants ne sont pas définis explicitement par le protocole OData :  

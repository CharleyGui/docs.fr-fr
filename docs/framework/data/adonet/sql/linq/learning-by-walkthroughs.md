...
- [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)]les procédures pas à pas requièrent généralement l’exemple de base de données Northwind. Pour plus d’informations, consultez [téléchargement d’exemples de bases de données](../../../../../../docs/framework/data/adonet/sql/linq/downloading-sample-databases.md).  

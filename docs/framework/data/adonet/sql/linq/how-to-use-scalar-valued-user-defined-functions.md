...
> [!NOTE]
> L'exécution directe se produit uniquement si la fonction est appelée à l'extérieur d'une requête. Pour plus d'informations, voir [Procédure : Appelez les fonctions définies par l’utilisateur Inline @ no__t-0.  

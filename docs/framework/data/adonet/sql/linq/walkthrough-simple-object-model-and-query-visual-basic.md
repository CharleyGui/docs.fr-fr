...
3. Également dans la boîte de dialogue **Ajouter une référence** , cliquez sur **.net**, faites défiler la liste jusqu’à et cliquez sur System. Windows. Forms, puis cliquez sur **OK**.

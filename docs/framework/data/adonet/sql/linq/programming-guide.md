...
## <a name="related-sections"></a>Rubriques connexes  
 ...
 Fournit des ressources pour vous aider à commencer à en savoir C#plus sur LINQ to SQL à l’aide de.

 [Introduction à LINQ (Visual Basic)](../../../../../visual-basic/programming-guide/concepts/linq/introduction-to-linq.md)  
 Fournit des ressources pour vous aider à commencer à vous familiariser avec la LINQ to SQL à l’aide de Visual Basic.

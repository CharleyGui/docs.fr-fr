...
[!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] fait partie de la famille de technologies ADO.NET. Il est basé sur les services fournis par le modèle de fournisseur ADO.NET. Vous pouvez donc mélanger [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] du code avec des applications ADO.NET existantes et migrer les solutions ADO.net actuelles vers [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] . L'illustration suivante fournit une vue d'ensemble de la relation.  

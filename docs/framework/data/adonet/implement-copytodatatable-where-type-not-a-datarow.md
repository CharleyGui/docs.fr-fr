...
---
# <a name="how-to-implement-copytodatatablet-where-the-generic-type-t-is-not-a-datarow"></a>Procédure : Implémenter CopyToDataTable\<T> quand le type générique T n’est pas un DataRow

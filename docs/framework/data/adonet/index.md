...
## <a name="related-sections"></a>Sections connexes  
 ...
 Décrit comment utiliser WCF Data Services pour déployer des services de données sur le Web ou sur un intranet qui implémentent le Open Data Protocol (OData).  
 ...
 Fournit une liste d’exemples et de didacticiels .NET.

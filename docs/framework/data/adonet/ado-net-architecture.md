---
title: Architecture
description: 'En savoir plus sur l’architecture ADO.NET, y compris les deux principaux composants d’accès et de manipulation des données : les fournisseurs de données .NET Framework et le jeu de données.'
ms.date: 03/30/2017
...
## <a name="adonet-components"></a>Composants d'ADO.NET  
 ...
 Les deux principaux composants de ADO.NET pour l’accès et la manipulation des données sont les fournisseurs de données .NET Framework et <xref:System.Data.DataSet> .  

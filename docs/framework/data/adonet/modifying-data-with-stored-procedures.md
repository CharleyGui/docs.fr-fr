...
> [!NOTE]
> Lorsque vous utilisez <xref:System.Data.OleDb.OleDbDataAdapter>, vous devez spécifier des paramètres avec <xref:System.Data.ParameterDirection> un de **returnValue** avant les autres paramètres.  

...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique : Lier un objet DataView à un contrôle DataGridView Windows Forms](how-to-bind-a-dataview-object-to-a-winforms-datagridview-control.md)  

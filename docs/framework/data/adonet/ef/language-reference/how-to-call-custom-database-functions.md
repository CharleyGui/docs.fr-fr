...
Ensuite, déclarez une fonction dans le Store Schema Definition Language (SSDL) de votre fichier *. edmx* . Le code suivant déclare la fonction `AvgStudentGrade` en SSDL :

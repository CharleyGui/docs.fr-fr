...
## <a name="example"></a>Exemple  
 ...
 La [!INCLUDE[esql](../../../../../../includes/esql-md.md)] requête suivante utilise l’opérateur is not null pour déterminer si une expression de requête n’a pas la valeur null. Cette requête est basée sur le modèle de vente AdventureWorks Sales Model. Pour compiler et exécuter cette requête, procédez comme suit :  

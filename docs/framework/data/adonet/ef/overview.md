...
## <a name="give-life-to-models"></a>Donnez vie aux modèles
 ...
 Le [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] donne vie aux modèles en permettant aux développeurs d’interroger des entités et des relations dans le modèle de domaine (appelé [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)]modèle conceptuel dans le) tout [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] en s’appuyant sur pour traduire ces opérations en source de données : commandes spécifiques. Cela libère les applications des dépendances codées en dur sur une source de données particulière.
...
- Le langage CSDL (Conceptual Schema Definition Language) définit le modèle conceptuel. Le langage CSDL [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)]est l’implémentation du [Entity Data Model](../entity-data-model.md). L’extension de fichier est .csdl.
...
[!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] inclut un fournisseur de données SqlClient mis à jour qui prend en charge les arborescences de commandes canoniques. Pour plus d’informations, consultez [SqlClient pour le Entity Framework](sqlclient-for-the-entity-framework.md).

## <a name="entity-data-model-tools"></a>Outils Entity Data Model

Avec le [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] Runtime, Visual Studio comprend les outils de mappage et de modélisation. Pour plus d’informations, consultez [modélisation et mappage](modeling-and-mapping.md).

## <a name="learn-more"></a>En savoir plus

Pour en savoir plus sur [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)]le, consultez :

[Prise en main](getting-started.md) -fournit des informations sur la façon d’être opérationnel rapidement à l’aide du [démarrage rapide](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/bb399182(v=vs.100)), qui montre comment créer [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] une application simple.

[Terminologie de Entity Framework](terminology.md) : définit un grand nombre des termes introduits par le Entity Data Model et [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] les et utilisés dans [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] la documentation.

[Ressources Entity Framework](resources.md) -fournit des liens vers des rubriques conceptuelles et des liens vers des rubriques [!INCLUDE[adonet_ef](../../../../../includes/adonet-ef-md.md)] et des ressources externes sur la création d’applications.

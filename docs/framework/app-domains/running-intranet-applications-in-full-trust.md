...
description: Exécuter des applications intranet en confiance totale avec .NET 3,5 SP1. Les applications et leurs assemblys de bibliothèque peuvent être exécutés en tant qu’assemblys de confiance totale à partir d’un partage réseau.
ms.date: 03/30/2017
helpviewer_keywords:

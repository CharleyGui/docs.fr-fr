...
description: Récupérer des ressources dans les applications de bureau. Ressources de package pour la culture par défaut (neutre) avec l’assembly principal et créez un assembly satellite pour chaque culture.
ms.date: 03/30/2017
dev_langs:
- csharp
- vb

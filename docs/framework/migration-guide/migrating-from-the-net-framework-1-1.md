...
[!INCLUDE[win7](../../../includes/win7-md.md)] et versions ultérieures du système d’exploitation Windows ne prennent pas en charge le .NET Framework 1.1. Par conséquent, les applications qui ciblent le .NET Framework 1.1 seront exécuteront pas sans modification [!INCLUDE[win7](../../../includes/win7-md.md)] ou versions ultérieures de système d’exploitation. Cette rubrique présente les étapes requises pour exécuter une application qui cible le .NET Framework 1.1 sous [!INCLUDE[win7](../../../includes/win7-md.md)] et versions ultérieures du système d’exploitation Windows. Pour plus d’informations sur le .NET Framework 1.1 et [!INCLUDE[win8](../../../includes/win8-md.md)], consultez [en cours d’exécution des applications .NET Framework 1.1 sur Windows 8 et versions ultérieures](../../../docs/framework/install/run-net-framework-1-1-apps.md).

## <a name="retargeting-or-recompiling"></a>Reciblage ou recompilation

Il existe deux façons d’obtenir une application qui a été compilée à l’aide de .NET Framework 1.1 pour s’exécuter sur [!INCLUDE[win7](../../../includes/win7-md.md)] ou un système d’exploitation de Windows versions ultérieur :
...
- Modifications avec rupture qui se sont produites entre le .NET Framework 1.1 et versions ultérieures du .NET Framework.

- Types et membres de type qui ont été marqués comme déconseillés ou obsolètes entre le .NET Framework 1.1 et versions ultérieures du .NET Framework.

Si vous reciblez votre application ou le recompiler, vous devez examiner à la fois les modifications avec rupture et les types et membres obsolètes pour chaque version du .NET Framework qui a été publiée après le .NET Framework 1.1.

## <a name="breaking-changes"></a>Modifications avec rupture

Lorsqu'une modification avec rupture se produit, selon la modification spécifique, une solution de contournement peut être disponible pour les applications reciblées et recompilées. Dans certains cas, vous pouvez ajouter un élément enfant à l'élément [\<runtime>](../../../docs/framework/configure-apps/file-schema/startup/supportedruntime-element.md) du fichier de configuration de votre application pour restaurer le comportement précédent. Par exemple, le fichier de configuration suivant restaure le tri de chaîne et comportement de comparaison utilisé dans le .NET Framework 1.1 et peut être utilisé avec un reciblée ou une application recompilée.
...
- [Modifications avec rupture dans .NET Framework 2.0](https://go.microsoft.com/fwlink/?LinkId=125263) décrit les modifications intervenues dans .NET Framework 2.0 SP1 qui peuvent affecter une application qui cible .NET Framework 1.1.

- [Modifications dans .NET Framework 3.5 SP1](https://go.microsoft.com/fwlink/?LinkID=186989) décrit les modifications intervenues entre le .NET Framework 3.5 et le [!INCLUDE[net_v35SP1_short](../../../includes/net-v35sp1-short-md.md)].
...
Pour évaluer l’impact des types et membres déconseillés depuis la version de .NET Framework 2.0 SP1, consultez [What ' s obsolètes dans la bibliothèque de classes](../../../docs/framework/whats-new/whats-obsolete.md). Passez en revue les listes de types et membres obsolètes pour le .NET Framework 2.0 SP1, le .NET Framework 3.5 et .NET Framework 4.

...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-47"></a><span data-ttu-id="82bf1-103">Modifications du Runtime pour la migration de .NET Framework 4.6.2 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="82bf1-103">Runtime Changes for Migration from .NET Framework 4.6.2 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="82bf1-104">Si vous effectuez une migration de .NET Framework 4.6.2 vers la version 4.7, consultez les rubriques suivantes pour connaître les éventuels problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="82bf1-104">If you are migrating from the .NET Framework 4.6.2 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="jit"></a><span data-ttu-id="82bf1-105">JIT</span><span class="sxs-lookup"><span data-stu-id="82bf1-105">JIT</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="82bf1-106">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="82bf1-106">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="82bf1-107">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="82bf1-107">Windows Workflow Foundation (WF)</span></span>

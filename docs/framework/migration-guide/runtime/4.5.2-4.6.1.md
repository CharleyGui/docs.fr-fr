...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a>Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.6.1

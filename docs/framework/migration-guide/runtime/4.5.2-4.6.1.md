...
ms.locfileid: "73128009"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="d3ea6-102">Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.6.1</span><span class="sxs-lookup"><span data-stu-id="d3ea6-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="d3ea6-103">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.6.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="d3ea6-103">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="d3ea6-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="d3ea6-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="d3ea6-105">Principal</span><span class="sxs-lookup"><span data-stu-id="d3ea6-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="d3ea6-106">Données</span><span class="sxs-lookup"><span data-stu-id="d3ea6-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="d3ea6-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="d3ea6-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="d3ea6-108">Réseau</span><span class="sxs-lookup"><span data-stu-id="d3ea6-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="d3ea6-109">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="d3ea6-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="d3ea6-110">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="d3ea6-110">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="d3ea6-111">Outils</span><span class="sxs-lookup"><span data-stu-id="d3ea6-111">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="d3ea6-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="d3ea6-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="d3ea6-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="d3ea6-113">Windows Presentation Foundation (WPF)</span></span>

---
title: Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.5.1
description: Recherchez des informations sur les problèmes de compatibilité des applications à partir des modifications du runtime qui peuvent affecter votre application lors de la migration de .NET Framework 4,5 vers la version 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "86443206"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a><span data-ttu-id="db47e-103">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.5.1</span><span class="sxs-lookup"><span data-stu-id="db47e-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="db47e-104">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.5.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="db47e-104">If you are migrating from the .NET Framework 4.5 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="db47e-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="db47e-105">ADO.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="db47e-106">Core</span><span class="sxs-lookup"><span data-stu-id="db47e-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="db47e-107">Données</span><span class="sxs-lookup"><span data-stu-id="db47e-107">Data</span></span>

[!INCLUDE[ADO.NET now attempts to automatically reconnect broken SQL connections](~/includes/migration-guide/runtime/adonet/adonet-now-attempts-automatically-reconnect-broken-sql-connections.md)]

## <a name="serialization"></a><span data-ttu-id="db47e-108">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="db47e-108">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="db47e-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="db47e-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="db47e-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="db47e-110">Windows Presentation Foundation (WPF)</span></span>

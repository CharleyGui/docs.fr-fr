...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-451"></a>Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.5.1

...
ms.locfileid: "85622495"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-48"></a><span data-ttu-id="a47a4-102">Modifications du runtime pour la migration de .NET Framework 4,0 à 4,8</span><span class="sxs-lookup"><span data-stu-id="a47a4-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="a47a4-103">Si vous effectuez une migration du .NET Framework 4,0 vers 4,8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="a47a4-103">If you are migrating from the .NET Framework 4.0 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="a47a4-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="a47a4-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="a47a4-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="a47a4-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="a47a4-106">Principal</span><span class="sxs-lookup"><span data-stu-id="a47a4-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="a47a4-107">Données</span><span class="sxs-lookup"><span data-stu-id="a47a4-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="a47a4-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="a47a4-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="a47a4-109">Globalisation</span><span class="sxs-lookup"><span data-stu-id="a47a4-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="a47a4-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="a47a4-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="a47a4-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="a47a4-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="a47a4-112">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="a47a4-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="a47a4-113">Impression</span><span class="sxs-lookup"><span data-stu-id="a47a4-113">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="a47a4-114">Runtime</span><span class="sxs-lookup"><span data-stu-id="a47a4-114">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="a47a4-115">Sécurité</span><span class="sxs-lookup"><span data-stu-id="a47a4-115">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="a47a4-116">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="a47a4-116">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="a47a4-117">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="a47a4-117">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="a47a4-118">Outils</span><span class="sxs-lookup"><span data-stu-id="a47a4-118">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="a47a4-119">Applications Web</span><span class="sxs-lookup"><span data-stu-id="a47a4-119">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="a47a4-120">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="a47a4-120">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="a47a4-121">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="a47a4-121">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="a47a4-122">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="a47a4-122">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="a47a4-123">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="a47a4-123">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="a47a4-124">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="a47a4-124">XML, XSLT</span></span>

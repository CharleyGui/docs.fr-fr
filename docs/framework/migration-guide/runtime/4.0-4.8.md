...
ms.locfileid: "86443284"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-48"></a><span data-ttu-id="9fef2-103">Modifications du runtime pour la migration de .NET Framework 4,0 à 4,8</span><span class="sxs-lookup"><span data-stu-id="9fef2-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="9fef2-104">Si vous effectuez une migration du .NET Framework 4,0 vers 4,8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="9fef2-104">If you are migrating from the .NET Framework 4.0 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="9fef2-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="9fef2-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="9fef2-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="9fef2-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="9fef2-107">Core</span><span class="sxs-lookup"><span data-stu-id="9fef2-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="9fef2-108">Données</span><span class="sxs-lookup"><span data-stu-id="9fef2-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="9fef2-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="9fef2-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="9fef2-110">Globalisation</span><span class="sxs-lookup"><span data-stu-id="9fef2-110">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="9fef2-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="9fef2-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="9fef2-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="9fef2-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="9fef2-113">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="9fef2-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="9fef2-114">Impression</span><span class="sxs-lookup"><span data-stu-id="9fef2-114">Printing</span></span>
...
## <a name="runtime"></a><span data-ttu-id="9fef2-115">Runtime</span><span class="sxs-lookup"><span data-stu-id="9fef2-115">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="9fef2-116">Sécurité</span><span class="sxs-lookup"><span data-stu-id="9fef2-116">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="9fef2-117">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="9fef2-117">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="9fef2-118">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="9fef2-118">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="9fef2-119">Outils</span><span class="sxs-lookup"><span data-stu-id="9fef2-119">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="9fef2-120">Applications Web</span><span class="sxs-lookup"><span data-stu-id="9fef2-120">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="9fef2-121">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="9fef2-121">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="9fef2-122">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="9fef2-122">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="9fef2-123">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="9fef2-123">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="9fef2-124">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="9fef2-124">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="9fef2-125">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="9fef2-125">XML, XSLT</span></span>

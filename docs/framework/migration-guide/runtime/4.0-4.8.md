...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-48"></a>Modifications du runtime pour la migration de .NET Framework 4,0 à 4,8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si vous effectuez une migration du .NET Framework 4,0 vers 4,8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :

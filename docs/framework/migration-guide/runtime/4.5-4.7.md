...
ms.locfileid: "91608091"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-47"></a><span data-ttu-id="65553-103">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.7</span><span class="sxs-lookup"><span data-stu-id="65553-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="65553-104">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="65553-104">If you are migrating from the .NET Framework 4.5 to 4.7, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="65553-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="65553-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="65553-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="65553-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="65553-107">Core</span><span class="sxs-lookup"><span data-stu-id="65553-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="65553-108">Données</span><span class="sxs-lookup"><span data-stu-id="65553-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="65553-109">Débogueur</span><span class="sxs-lookup"><span data-stu-id="65553-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="65553-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="65553-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="65553-111">Globalisation</span><span class="sxs-lookup"><span data-stu-id="65553-111">Globalization</span></span>
...
## <a name="jit"></a><span data-ttu-id="65553-112">JIT</span><span class="sxs-lookup"><span data-stu-id="65553-112">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="65553-113">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="65553-113">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="65553-114">Sécurité</span><span class="sxs-lookup"><span data-stu-id="65553-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="65553-115">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="65553-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="65553-116">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="65553-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="65553-117">Outils</span><span class="sxs-lookup"><span data-stu-id="65553-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="65553-118">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="65553-118">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="65553-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="65553-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="65553-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="65553-120">Windows Workflow Foundation (WF)</span></span>

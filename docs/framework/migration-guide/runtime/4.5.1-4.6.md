---
title: Modifications du Runtime pour la migration de .NET Framework 4.5.1 vers la version 4.6
description: Recherchez des informations sur les problèmes de compatibilité des applications à partir des modifications du runtime qui peuvent affecter votre application lors de la migration de .NET Framework 4.5.1 vers 4,6.
ms.date: 07/10/2019
...
ms.locfileid: "97009857"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-46"></a><span data-ttu-id="83e72-103">Modifications du Runtime pour la migration de .NET Framework 4.5.1 vers la version 4.6</span><span class="sxs-lookup"><span data-stu-id="83e72-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="83e72-104">Si vous effectuez une migration de .NET Framework 4.5.1 vers la version 4.6, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="83e72-104">If you are migrating from the .NET Framework 4.5.1 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="83e72-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="83e72-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="83e72-106">Core</span><span class="sxs-lookup"><span data-stu-id="83e72-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="83e72-107">Données</span><span class="sxs-lookup"><span data-stu-id="83e72-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="83e72-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="83e72-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="83e72-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="83e72-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="83e72-110">Réseau</span><span class="sxs-lookup"><span data-stu-id="83e72-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="83e72-111">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="83e72-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="83e72-112">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="83e72-112">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="83e72-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="83e72-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="83e72-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="83e72-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="83e72-115">XML</span><span class="sxs-lookup"><span data-stu-id="83e72-115">XML</span></span>

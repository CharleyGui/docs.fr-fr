...
---
# <a name="runtime-changes-for-migration-from-net-framework-47-to-471"></a>Modifications du Runtime pour la migration de .NET Framework 4.7 vers la version 4.7.1

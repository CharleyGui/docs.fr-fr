...
ms.locfileid: "86443674"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-452"></a><span data-ttu-id="4833e-103">Modifications du Runtime pour la migration de .NET Framework 4.0 vers la version 4.5.2</span><span class="sxs-lookup"><span data-stu-id="4833e-103">Runtime Changes for Migration from .NET Framework 4.0 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="4833e-104">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.5.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="4833e-104">If you are migrating from the .NET Framework 4.0 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="4833e-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="4833e-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="4833e-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="4833e-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="4833e-107">Core</span><span class="sxs-lookup"><span data-stu-id="4833e-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="4833e-108">Données</span><span class="sxs-lookup"><span data-stu-id="4833e-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="4833e-109">Débogueur</span><span class="sxs-lookup"><span data-stu-id="4833e-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="4833e-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="4833e-110">Entity Framework</span></span>
...
## <a name="linq"></a><span data-ttu-id="4833e-111">LINQ</span><span class="sxs-lookup"><span data-stu-id="4833e-111">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="4833e-112">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="4833e-112">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="4833e-113">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="4833e-113">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="4833e-114">Impression</span><span class="sxs-lookup"><span data-stu-id="4833e-114">Printing</span></span>
...
## <a name="serialization"></a><span data-ttu-id="4833e-115">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="4833e-115">Serialization</span></span>
...
## <a name="web-applications"></a><span data-ttu-id="4833e-116">Applications Web</span><span class="sxs-lookup"><span data-stu-id="4833e-116">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="4833e-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="4833e-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="4833e-118">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="4833e-118">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="4833e-119">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="4833e-119">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="4833e-120">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="4833e-120">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="4833e-121">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="4833e-121">XML, XSLT</span></span>

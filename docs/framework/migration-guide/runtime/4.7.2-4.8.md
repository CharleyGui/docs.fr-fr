...
ms.locfileid: "67802687"
---
# <a name="runtime-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="0f838-102">Changements de runtime pour la migration de .NET Framework 4.7.2 vers la version 4.8</span><span class="sxs-lookup"><span data-stu-id="0f838-102">Runtime Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="0f838-103">Si vous effectuez une migration de .NET Framework 4.7.2 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="0f838-103">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="0f838-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="0f838-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="0f838-105">Principal</span><span class="sxs-lookup"><span data-stu-id="0f838-105">Core</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0f838-106">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0f838-106">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0f838-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0f838-107">Windows Presentation Foundation (WPF)</span></span>

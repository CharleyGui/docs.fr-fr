...
ms.locfileid: "66379381"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="de7d7-102">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.5.2</span><span class="sxs-lookup"><span data-stu-id="de7d7-102">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="de7d7-103">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.5.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="de7d7-103">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="de7d7-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="de7d7-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="de7d7-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="de7d7-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="de7d7-106">Principal</span><span class="sxs-lookup"><span data-stu-id="de7d7-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="de7d7-107">Données</span><span class="sxs-lookup"><span data-stu-id="de7d7-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="de7d7-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="de7d7-108">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="de7d7-109">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="de7d7-109">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="de7d7-110">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="de7d7-110">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="de7d7-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="de7d7-111">Windows Presentation Foundation (WPF)</span></span>

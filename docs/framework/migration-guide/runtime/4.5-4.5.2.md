...
ms.locfileid: "91609757"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="b55e6-103">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.5.2</span><span class="sxs-lookup"><span data-stu-id="b55e6-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="b55e6-104">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.5.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="b55e6-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="b55e6-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="b55e6-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="b55e6-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="b55e6-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="b55e6-107">Core</span><span class="sxs-lookup"><span data-stu-id="b55e6-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="b55e6-108">Données</span><span class="sxs-lookup"><span data-stu-id="b55e6-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="b55e6-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="b55e6-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="b55e6-110">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="b55e6-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="b55e6-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="b55e6-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="b55e6-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="b55e6-112">Windows Presentation Foundation (WPF)</span></span>

...
ms.locfileid: "85622482"
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-462"></a><span data-ttu-id="7eb40-102">Modifications du Runtime pour la migration de .NET Framework 4.0 vers la version 4.6.2</span><span class="sxs-lookup"><span data-stu-id="7eb40-102">Runtime Changes for Migration from .NET Framework 4.0 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="7eb40-103">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.6.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="7eb40-103">If you are migrating from the .NET Framework 4.0 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="7eb40-104">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="7eb40-104">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="7eb40-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="7eb40-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="7eb40-106">Principal</span><span class="sxs-lookup"><span data-stu-id="7eb40-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="7eb40-107">Données</span><span class="sxs-lookup"><span data-stu-id="7eb40-107">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="7eb40-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="7eb40-108">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="7eb40-109">Globalisation</span><span class="sxs-lookup"><span data-stu-id="7eb40-109">Globalization</span></span>
...
## <a name="linq"></a><span data-ttu-id="7eb40-110">LINQ</span><span class="sxs-lookup"><span data-stu-id="7eb40-110">LINQ</span></span>
...
## <a name="managed-extensibility-framework-mef"></a><span data-ttu-id="7eb40-111">Managed Extensibility Framework (MEF)</span><span class="sxs-lookup"><span data-stu-id="7eb40-111">Managed Extensibility Framework (MEF)</span></span>
...
## <a name="networking"></a><span data-ttu-id="7eb40-112">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="7eb40-112">Networking</span></span>
...
## <a name="printing"></a><span data-ttu-id="7eb40-113">Impression</span><span class="sxs-lookup"><span data-stu-id="7eb40-113">Printing</span></span>
...
## <a name="security"></a><span data-ttu-id="7eb40-114">Sécurité</span><span class="sxs-lookup"><span data-stu-id="7eb40-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="7eb40-115">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="7eb40-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="7eb40-116">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="7eb40-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="7eb40-117">Outils</span><span class="sxs-lookup"><span data-stu-id="7eb40-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="7eb40-118">Applications Web</span><span class="sxs-lookup"><span data-stu-id="7eb40-118">Web Applications</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="7eb40-119">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="7eb40-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="7eb40-120">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="7eb40-120">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="7eb40-121">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="7eb40-121">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="7eb40-122">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="7eb40-122">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="7eb40-123">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="7eb40-123">XML, XSLT</span></span>

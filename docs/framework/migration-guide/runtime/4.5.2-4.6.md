...
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a>Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.6

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.6, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :

---
title: Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.6
description: Recherchez des informations sur les problèmes de compatibilité des applications à partir des modifications du runtime qui peuvent affecter votre application lors de la migration de .NET Framework 4.5.2 à 4,6.
ms.date: 07/10/2019
...
ms.locfileid: "86442166"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="2b939-103">Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.6</span><span class="sxs-lookup"><span data-stu-id="2b939-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="2b939-104">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.6, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="2b939-104">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="2b939-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2b939-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="2b939-106">Core</span><span class="sxs-lookup"><span data-stu-id="2b939-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="2b939-107">Données</span><span class="sxs-lookup"><span data-stu-id="2b939-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="2b939-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="2b939-108">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="2b939-109">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="2b939-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="2b939-110">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="2b939-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="2b939-111">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="2b939-111">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2b939-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2b939-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2b939-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2b939-113">Windows Presentation Foundation (WPF)</span></span>

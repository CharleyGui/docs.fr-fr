...
ms.locfileid: "73196117"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-46"></a><span data-ttu-id="6e777-102">Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.6</span><span class="sxs-lookup"><span data-stu-id="6e777-102">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="6e777-103">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.6, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="6e777-103">If you are migrating from the .NET Framework 4.5.2 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="6e777-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="6e777-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="6e777-105">Principal</span><span class="sxs-lookup"><span data-stu-id="6e777-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="6e777-106">Données</span><span class="sxs-lookup"><span data-stu-id="6e777-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="6e777-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="6e777-107">Debugger</span></span>
...
## <a name="networking"></a><span data-ttu-id="6e777-108">Réseau</span><span class="sxs-lookup"><span data-stu-id="6e777-108">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="6e777-109">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="6e777-109">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="6e777-110">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="6e777-110">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="6e777-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="6e777-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="6e777-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="6e777-112">Windows Presentation Foundation (WPF)</span></span>

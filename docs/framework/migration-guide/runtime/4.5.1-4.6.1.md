...
ms.locfileid: "73106054"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="f4c94-102">Modifications du Runtime pour la migration de .NET Framework 4.5.1 vers la version 4.6.1</span><span class="sxs-lookup"><span data-stu-id="f4c94-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

[!INCLUDE[introduction](../../../../includes/migration-guide/runtime/introduction.md)]

<span data-ttu-id="f4c94-103">Si vous effectuez une migration de .NET Framework 4.5.1 vers la version 4.6.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="f4c94-103">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="f4c94-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="f4c94-104">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="f4c94-105">Principal</span><span class="sxs-lookup"><span data-stu-id="f4c94-105">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="f4c94-106">Données</span><span class="sxs-lookup"><span data-stu-id="f4c94-106">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="f4c94-107">Débogueur</span><span class="sxs-lookup"><span data-stu-id="f4c94-107">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="f4c94-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="f4c94-108">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="f4c94-109">Réseau</span><span class="sxs-lookup"><span data-stu-id="f4c94-109">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="f4c94-110">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="f4c94-110">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="f4c94-111">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="f4c94-111">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="f4c94-112">Outils</span><span class="sxs-lookup"><span data-stu-id="f4c94-112">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="f4c94-113">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="f4c94-113">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="f4c94-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="f4c94-114">Windows Presentation Foundation (WPF)</span></span>

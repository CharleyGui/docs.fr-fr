---
title: Modifications du Runtime pour la migration de .NET Framework 4.6 vers la version 4.7.1
description: Recherchez des informations sur les problèmes de compatibilité des applications à partir des modifications du runtime qui peuvent affecter votre application lors de la migration de .NET Framework 4,6 vers la version 4.7.1.
ms.date: 07/10/2019
...
ms.locfileid: "86441984"
---
# <a name="runtime-changes-for-migration-from-net-framework-46-to-471"></a><span data-ttu-id="0ee0d-103">Modifications du Runtime pour la migration de .NET Framework 4.6 vers la version 4.7.1</span><span class="sxs-lookup"><span data-stu-id="0ee0d-103">Runtime Changes for Migration from .NET Framework 4.6 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="0ee0d-104">Si vous effectuez une migration de .NET Framework 4.6 vers la version 4.7.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="0ee0d-104">If you are migrating from the .NET Framework 4.6 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="data"></a><span data-ttu-id="0ee0d-105">Données</span><span class="sxs-lookup"><span data-stu-id="0ee0d-105">Data</span></span>
...
## <a name="globalization"></a><span data-ttu-id="0ee0d-106">Globalisation</span><span class="sxs-lookup"><span data-stu-id="0ee0d-106">Globalization</span></span>
...
## <a name="security"></a><span data-ttu-id="0ee0d-107">Sécurité</span><span class="sxs-lookup"><span data-stu-id="0ee0d-107">Security</span></span>
...
## <a name="tools"></a><span data-ttu-id="0ee0d-108">Outils</span><span class="sxs-lookup"><span data-stu-id="0ee0d-108">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="0ee0d-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="0ee0d-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="0ee0d-110">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="0ee0d-110">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="0ee0d-111">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="0ee0d-111">Windows Workflow Foundation (WF)</span></span>

...
---
# <a name="runtime-changes-for-migration-from-net-framework-40-to-47"></a>Modifications du Runtime pour la migration de .NET Framework 4.0 vers la version 4.7

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.7, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :

...
---
# <a name="runtime-changes-for-migration-from-net-framework-471-to-48"></a>Changements de runtime pour la migration de .NET Framework 4.7.1 vers la version 4.8

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Si vous effectuez une migration de .NET Framework 4.7.1 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :

---
title: Changements de runtime pour la migration de .NET Framework 4.5.2 vers la version 4.8
description: Recherchez des informations sur les problèmes de compatibilité des applications à partir des modifications du runtime qui peuvent affecter votre application lors de la migration de .NET Framework 4.5.2 à 4,8.
ms.date: 07/10/2019
...
ms.locfileid: "86444077"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-48"></a><span data-ttu-id="78cbc-103">Changements de runtime pour la migration de .NET Framework 4.5.2 vers la version 4.8</span><span class="sxs-lookup"><span data-stu-id="78cbc-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="78cbc-104">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="78cbc-104">If you are migrating from the .NET Framework 4.5.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="78cbc-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="78cbc-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="78cbc-106">Core</span><span class="sxs-lookup"><span data-stu-id="78cbc-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="78cbc-107">Données</span><span class="sxs-lookup"><span data-stu-id="78cbc-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="78cbc-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="78cbc-108">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="78cbc-109">Globalisation</span><span class="sxs-lookup"><span data-stu-id="78cbc-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="78cbc-110">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="78cbc-110">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="78cbc-111">Runtime</span><span class="sxs-lookup"><span data-stu-id="78cbc-111">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="78cbc-112">Sécurité</span><span class="sxs-lookup"><span data-stu-id="78cbc-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="78cbc-113">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="78cbc-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="78cbc-114">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="78cbc-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="78cbc-115">Outils</span><span class="sxs-lookup"><span data-stu-id="78cbc-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="78cbc-116">Applications Web</span><span class="sxs-lookup"><span data-stu-id="78cbc-116">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="78cbc-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="78cbc-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="78cbc-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="78cbc-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="78cbc-119">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="78cbc-119">Windows Workflow Foundation (WF)</span></span>

...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-452"></a><span data-ttu-id="dfe7d-102">Modifications du Runtime pour la migration de .NET Framework 4.5.1 vers la version 4.5.2</span><span class="sxs-lookup"><span data-stu-id="dfe7d-102">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="dfe7d-103">Si vous effectuez une migration de .NET Framework 4.5.1 vers la version 4.5.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="dfe7d-103">If you are migrating from the .NET Framework 4.5.1 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="dfe7d-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dfe7d-104">ASP.NET</span></span>
...
## <a name="data"></a><span data-ttu-id="dfe7d-105">Données</span><span class="sxs-lookup"><span data-stu-id="dfe7d-105">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="dfe7d-106">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="dfe7d-106">Entity Framework</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dfe7d-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dfe7d-107">Windows Presentation Foundation (WPF)</span></span>

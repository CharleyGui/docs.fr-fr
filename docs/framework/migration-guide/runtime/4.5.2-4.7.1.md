---
title: Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.7.1
description: Recherchez des informations sur les problèmes de compatibilité des applications à partir des modifications du runtime qui peuvent affecter votre application lors de la migration de .NET Framework 4.5.2 vers la version 4.7.1.
ms.date: 07/10/2019
...
ms.locfileid: "86442218"
---
# <a name="runtime-changes-for-migration-from-net-framework-452-to-471"></a><span data-ttu-id="c1b0e-103">Modifications du Runtime pour la migration de .NET Framework 4.5.2 vers la version 4.7.1</span><span class="sxs-lookup"><span data-stu-id="c1b0e-103">Runtime Changes for Migration from .NET Framework 4.5.2 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="c1b0e-104">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.7.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="c1b0e-104">If you are migrating from the .NET Framework 4.5.2 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c1b0e-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c1b0e-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c1b0e-106">Core</span><span class="sxs-lookup"><span data-stu-id="c1b0e-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="c1b0e-107">Données</span><span class="sxs-lookup"><span data-stu-id="c1b0e-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="c1b0e-108">Débogueur</span><span class="sxs-lookup"><span data-stu-id="c1b0e-108">Debugger</span></span>
...
## <a name="globalization"></a><span data-ttu-id="c1b0e-109">Globalisation</span><span class="sxs-lookup"><span data-stu-id="c1b0e-109">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="c1b0e-110">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="c1b0e-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c1b0e-111">Sécurité</span><span class="sxs-lookup"><span data-stu-id="c1b0e-111">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="c1b0e-112">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="c1b0e-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="c1b0e-113">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="c1b0e-113">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="c1b0e-114">Outils</span><span class="sxs-lookup"><span data-stu-id="c1b0e-114">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c1b0e-115">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c1b0e-115">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c1b0e-116">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c1b0e-116">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c1b0e-117">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c1b0e-117">Windows Workflow Foundation (WF)</span></span>

...
ms.locfileid: "86442986"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-46"></a><span data-ttu-id="2991d-103">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.6</span><span class="sxs-lookup"><span data-stu-id="2991d-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="2991d-104">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.6, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="2991d-104">If you are migrating from the .NET Framework 4.5 to 4.6, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="2991d-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="2991d-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="2991d-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2991d-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="2991d-107">Core</span><span class="sxs-lookup"><span data-stu-id="2991d-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="2991d-108">Données</span><span class="sxs-lookup"><span data-stu-id="2991d-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="2991d-109">Débogueur</span><span class="sxs-lookup"><span data-stu-id="2991d-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="2991d-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="2991d-110">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="2991d-111">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="2991d-111">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="2991d-112">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="2991d-112">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="2991d-113">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="2991d-113">Setup and Deployment</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="2991d-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="2991d-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2991d-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2991d-115">Windows Presentation Foundation (WPF)</span></span>

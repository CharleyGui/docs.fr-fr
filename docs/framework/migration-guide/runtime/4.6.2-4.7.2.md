...
---
# <a name="runtime-changes-for-migration-from-net-framework-462-to-472"></a>Modifications du Runtime pour la migration de .NET Framework 4.6.2 vers la version 4.7.2

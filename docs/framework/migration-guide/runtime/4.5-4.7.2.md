...
ms.locfileid: "91608001"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-472"></a><span data-ttu-id="01657-103">Modifications du Runtime pour la migration de .NET Framework 4.5 vers la version 4.7.2</span><span class="sxs-lookup"><span data-stu-id="01657-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.7.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="01657-104">Si vous effectuez une migration de .NET Framework 4.5 vers la version 4.7.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’impacter votre application :</span><span class="sxs-lookup"><span data-stu-id="01657-104">If you are migrating from the .NET Framework 4.5 to 4.7.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="01657-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="01657-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="01657-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="01657-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="01657-107">Core</span><span class="sxs-lookup"><span data-stu-id="01657-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="01657-108">Données</span><span class="sxs-lookup"><span data-stu-id="01657-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="01657-109">Débogueur</span><span class="sxs-lookup"><span data-stu-id="01657-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="01657-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="01657-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="01657-111">Globalisation</span><span class="sxs-lookup"><span data-stu-id="01657-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="01657-112">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="01657-112">Networking</span></span>
...
## <a name="runtime"></a><span data-ttu-id="01657-113">Runtime</span><span class="sxs-lookup"><span data-stu-id="01657-113">Runtime</span></span>

[!INCLUDE[Improved WCF chain trust certificate validation for Net.Tcp certificate authentication](~/includes/migration-guide/runtime/runtime/improved-wcf-chain-trust-certificate-validation-for-nettcp-authentication.md)]

## <a name="security"></a><span data-ttu-id="01657-114">Sécurité</span><span class="sxs-lookup"><span data-stu-id="01657-114">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="01657-115">Sérialisation</span><span class="sxs-lookup"><span data-stu-id="01657-115">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="01657-116">Configuration et déploiement</span><span class="sxs-lookup"><span data-stu-id="01657-116">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="01657-117">Outils</span><span class="sxs-lookup"><span data-stu-id="01657-117">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="web-applications"></a><span data-ttu-id="01657-118">Applications Web</span><span class="sxs-lookup"><span data-stu-id="01657-118">Web Applications</span></span>

[!INCLUDE["dataAnnotations:dataTypeAttribute:disableRegEx" app setting is on by default in .NET Framework 4.7.2](~/includes/migration-guide/runtime/web/dataannotationsdatatypeattributedisableregex-app-setting-on-by-default-net.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="01657-119">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="01657-119">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="01657-120">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="01657-120">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="01657-121">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="01657-121">Windows Workflow Foundation (WF)</span></span>

---
title: Changements de reciblage pour la migration de .NET Framework 4.6.2 vers la version 4.8
description: Trouvez des informations sur les problèmes de compatibilité des applications qui peuvent affecter votre application lors de la migration de .NET Framework 4.6.2 vers 4,8.
ms.date: 07/10/2019
...
ms.locfileid: "86443336"
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-48"></a><span data-ttu-id="18ae0-103">Changements de reciblage pour la migration de .NET Framework 4.6.2 vers la version 4.8</span><span class="sxs-lookup"><span data-stu-id="18ae0-103">Retargeting Changes for Migration from .NET Framework 4.6.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="18ae0-104">Si vous effectuez une migration de .NET Framework 4.6.2 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="18ae0-104">If you are migrating from the .NET Framework 4.6.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="18ae0-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="18ae0-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="18ae0-106">Core</span><span class="sxs-lookup"><span data-stu-id="18ae0-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="18ae0-107">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="18ae0-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="18ae0-108">Sécurité</span><span class="sxs-lookup"><span data-stu-id="18ae0-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="18ae0-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="18ae0-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="18ae0-110">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="18ae0-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="18ae0-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="18ae0-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="18ae0-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="18ae0-112">Windows Workflow Foundation (WF)</span></span>

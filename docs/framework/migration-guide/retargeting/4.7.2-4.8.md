...
ms.locfileid: "95727027"
---
# <a name="retargeting-changes-for-migration-from-net-framework-472-to-48"></a><span data-ttu-id="fae23-103">Changements de reciblage pour la migration de .NET Framework 4.7.2 vers la version 4.8</span><span class="sxs-lookup"><span data-stu-id="fae23-103">Retargeting Changes for Migration from .NET Framework 4.7.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="fae23-104">Si vous effectuez une migration de .NET Framework 4.7.2 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="fae23-104">If you are migrating from the .NET Framework 4.7.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="fae23-105">Base</span><span class="sxs-lookup"><span data-stu-id="fae23-105">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="fae23-106">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="fae23-106">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="fae23-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="fae23-107">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="fae23-108">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="fae23-108">Windows Workflow Foundation (WF)</span></span>

---
title: Modifications de reciblage pour la migration de .NET Framework 4.0 vers la version 4.5.1
description: Trouvez des informations sur les problèmes de compatibilité des applications qui peuvent affecter votre application lors de la migration de .NET Framework 4,0 vers la version 4.5.1.
ms.date: 07/10/2019
...
ms.locfileid: "86444454"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a><span data-ttu-id="88471-103">Modifications de reciblage pour la migration de .NET Framework 4.0 vers la version 4.5.1</span><span class="sxs-lookup"><span data-stu-id="88471-103">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="88471-104">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.5.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="88471-104">If you are migrating from the .NET Framework 4.0 to 4.5.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="88471-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="88471-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="88471-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="88471-106">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="88471-107">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="88471-107">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="88471-108">Core</span><span class="sxs-lookup"><span data-stu-id="88471-108">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="88471-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="88471-109">Entity Framework</span></span>
...
## <a name="msbuild"></a><span data-ttu-id="88471-110">MSBuild</span><span class="sxs-lookup"><span data-stu-id="88471-110">MSBuild</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="88471-111">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="88471-111">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="88471-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="88471-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="88471-113">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="88471-113">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="88471-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="88471-114">XML, XSLT</span></span>

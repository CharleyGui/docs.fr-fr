...
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-451"></a>Modifications de reciblage pour la migration de .NET Framework 4.0 vers la version 4.5.1

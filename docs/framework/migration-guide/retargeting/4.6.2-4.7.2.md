...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-472"></a>Modifications de reciblage pour la migration de .NET Framework 4.6.2 vers la version 4.7.2

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

Si vous effectuez une migration de .NET Framework 4.6.2 vers la version 4.7.2, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’impacter votre application :

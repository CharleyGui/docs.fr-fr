...
---
# <a name="retargeting-changes-for-migration-from-net-framework-451-to-471"></a>Modifications de reciblage pour la migration de .NET Framework 4.5.1 vers la version 4.7.1

...
---
# <a name="retargeting-changes-for-migration-from-net-framework-46-to-471"></a>Modifications de reciblage pour la migration de .NET Framework 4.6 vers la version 4.7.1

...
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-47"></a>Reciblage des modifications pour la migration à partir de .NET Framework 4.6.2 à 4.7

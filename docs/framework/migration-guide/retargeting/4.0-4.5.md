...
ms.locfileid: "85620961"
---
# <a name="retargeting-changes-for-migration-from-net-framework-40-to-45"></a><span data-ttu-id="2c4f1-102">Modifications de reciblage pour la migration de .NET Framework 4.0 vers la version 4.5</span><span class="sxs-lookup"><span data-stu-id="2c4f1-102">Retargeting Changes for Migration from .NET Framework 4.0 to 4.5</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="2c4f1-103">Si vous effectuez une migration de .NET Framework 4.0 vers la version 4.5, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="2c4f1-103">If you are migrating from the .NET Framework 4.0 to 4.5, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="2c4f1-104">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="2c4f1-104">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="2c4f1-105">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="2c4f1-105">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="2c4f1-106">Principal</span><span class="sxs-lookup"><span data-stu-id="2c4f1-106">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="2c4f1-107">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="2c4f1-107">Entity Framework</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="2c4f1-108">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="2c4f1-108">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2c4f1-109">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2c4f1-109">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="2c4f1-110">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="2c4f1-110">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="2c4f1-111">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="2c4f1-111">XML, XSLT</span></span>

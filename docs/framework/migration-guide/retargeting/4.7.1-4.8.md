---
title: Modifications de reciblage pour la migration de .NET Framework 4.7.1 vers 4,8
description: Trouvez des informations sur les problèmes de compatibilité des applications qui peuvent affecter votre application lors de la migration de .NET Framework 4.7.1 vers 4,8.
ms.date: 07/10/2019
...
ms.locfileid: "95733085"
---
# <a name="retargeting-changes-for-migration-from-net-framework-471-to-48"></a><span data-ttu-id="2ac93-103">Modifications de reciblage pour la migration de .NET Framework 4.7.1 vers 4,8</span><span class="sxs-lookup"><span data-stu-id="2ac93-103">Retargeting Changes for Migration from .NET Framework 4.7.1 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="2ac93-104">Si vous effectuez une migration de .NET Framework 4.7.1 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="2ac93-104">If you are migrating from the .NET Framework 4.7.1 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="core"></a><span data-ttu-id="2ac93-105">Base</span><span class="sxs-lookup"><span data-stu-id="2ac93-105">Core</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="2ac93-106">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="2ac93-106">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="2ac93-107">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="2ac93-107">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="2ac93-108">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="2ac93-108">Windows Workflow Foundation (WF)</span></span>

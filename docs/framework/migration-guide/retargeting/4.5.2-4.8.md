...
ms.locfileid: "95681598"
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-48"></a><span data-ttu-id="dc294-103">Changements de reciblage pour la migration de .NET Framework 4.5.2 vers la version 4.8</span><span class="sxs-lookup"><span data-stu-id="dc294-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="dc294-104">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.8, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="dc294-104">If you are migrating from the .NET Framework 4.5.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="dc294-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dc294-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="dc294-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="dc294-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="dc294-107">Base</span><span class="sxs-lookup"><span data-stu-id="dc294-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="dc294-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="dc294-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="dc294-109">JIT</span><span class="sxs-lookup"><span data-stu-id="dc294-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="dc294-110">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="dc294-110">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="dc294-111">Sécurité</span><span class="sxs-lookup"><span data-stu-id="dc294-111">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="dc294-112">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="dc294-112">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="dc294-113">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="dc294-113">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dc294-114">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dc294-114">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="dc294-115">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="dc294-115">Windows Workflow Foundation (WF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="dc294-116">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="dc294-116">XML, XSLT</span></span>

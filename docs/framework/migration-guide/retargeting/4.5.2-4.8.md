...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-48"></a>Changements de reciblage pour la migration de .NET Framework 4.5.2 vers la version 4.8

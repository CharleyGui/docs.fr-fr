...
---
# <a name="retargeting-changes-for-migration-from-net-framework-452-to-461"></a><span data-ttu-id="cd1fa-103">Modifications de reciblage pour la migration de .NET Framework 4.5.2 vers la version 4.6.1</span><span class="sxs-lookup"><span data-stu-id="cd1fa-103">Retargeting Changes for Migration from .NET Framework 4.5.2 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="cd1fa-104">Si vous effectuez une migration de .NET Framework 4.5.2 vers la version 4.6.1, consultez les rubriques suivantes pour connaître les problèmes de compatibilité susceptibles d’affecter votre application :</span><span class="sxs-lookup"><span data-stu-id="cd1fa-104">If you are migrating from the .NET Framework 4.5.2 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="cd1fa-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="cd1fa-105">ASP.NET</span></span>
...
## <a name="clickonce"></a><span data-ttu-id="cd1fa-106">ClickOnce</span><span class="sxs-lookup"><span data-stu-id="cd1fa-106">ClickOnce</span></span>
...
## <a name="core"></a><span data-ttu-id="cd1fa-107">Core</span><span class="sxs-lookup"><span data-stu-id="cd1fa-107">Core</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="cd1fa-108">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="cd1fa-108">Entity Framework</span></span>
...
## <a name="jit"></a><span data-ttu-id="cd1fa-109">JIT</span><span class="sxs-lookup"><span data-stu-id="cd1fa-109">JIT</span></span>
...
## <a name="networking"></a><span data-ttu-id="cd1fa-110">Mise en réseau</span><span class="sxs-lookup"><span data-stu-id="cd1fa-110">Networking</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="cd1fa-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="cd1fa-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="cd1fa-112">Windows Forms</span><span class="sxs-lookup"><span data-stu-id="cd1fa-112">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="cd1fa-113">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="cd1fa-113">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml-xslt"></a><span data-ttu-id="cd1fa-114">XML, XSLT</span><span class="sxs-lookup"><span data-stu-id="cd1fa-114">XML, XSLT</span></span>

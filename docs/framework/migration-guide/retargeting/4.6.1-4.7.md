...
---
# <a name="retargeting-changes-for-migration-from-net-framework-461-to-47"></a>Modifications de reciblage pour la migration de .NET Framework 4.6.1 vers la version 4.7

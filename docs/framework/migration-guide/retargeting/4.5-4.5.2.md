...
---
# <a name="retargeting-changes-for-migration-from-net-framework-45-to-452"></a>Modifications de reciblage pour la migration de .NET Framework 4.5 vers la version 4.5.2

...
description: Obtenir des détails sur Gacutil.exe, l’outil global assembly cache. Cet outil vous permet d’afficher et de manipuler le Global Assembly Cache et le cache de téléchargement.
ms.date: 03/30/2017
helpviewer_keywords:
...
|--------------|-----------------|
|*NomAssembly*|Nom d'un assembly. Vous pouvez indiquer un nom d'assembly partiellement spécifié, tel que `myAssembly` ou un nom d'assembly complètement spécifié, tel que `myAssembly, Version=2.0.0.0, Culture=neutral, PublicKeyToken=0038abc9deabfle5`.|
...
|**/ir**  *assemblyPath*<br /><br /> *mode*<br /><br /> *id*<br /><br /> *description*|Installe un assembly dans le Global Assembly Cache et ajoute une référence pour compter l'assembly. Vous devez spécifier les paramètres *assemblyPath*, *scheme*, *id* et *description* avec cette option. Pour obtenir une description des valeurs valides que vous pouvez spécifier pour ces paramètres, consultez l’option **/r**.<br /><br /> La spécification de cette option revient à spécifier les options **/i** et **/r** ensemble.|

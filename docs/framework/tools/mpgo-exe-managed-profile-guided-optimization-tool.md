...
|`-Timeout` \<*secondes*>|Durée pendant laquelle l’application Windows 8. x Store s’exécute avant la fermeture de l’application.|
...
- [Présentation des améliorations des performances de .NET 4.5](https://docs.microsoft.com/archive/msdn-magazine/2012/april/clr-an-overview-of-performance-improvements-in-net-4-5)

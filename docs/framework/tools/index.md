...
## <a name="in-this-section"></a>Dans cette section  
 ...
 Permet d'afficher et de configurer la stratégie de sécurité au niveau de l'ordinateur, de l'utilisateur et de l'entreprise. Dans .NET Framework 4 et versions ultérieures, cet outil n’affecte pas la stratégie de sécurité d’accès du code (CAS), à moins que l’[élément \<legacyCasPolicy>](../configure-apps/file-schema/runtime/netfx40-legacysecuritypolicy-element.md) soit défini sur `true`. Pour plus d’informations, consultez [Changements en matière de sécurité](../security/security-changes.md).  
...
## <a name="related-sections"></a>Rubriques connexes  
 ...
 [Outils Windows Communication Foundation](../wcf/tools.md)  

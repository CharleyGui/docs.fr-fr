...
|---------------|--------------------|-----------------|  
|`Name`|Généralités|Attribut requis. Spécifie le nom de l'espace de noms.|  
...
|Valeur|Description|  
|-----------|-----------------|  
|*paramètre_stratégie*|Le paramètre s'applique à ce type de stratégie pour tous les types dans l'espace de noms. Les valeurs possibles sont `All`, `Auto`, `Excluded`, `Public`, `PublicAndInternal`, `Required Public`, `Required PublicAndInternal` et `Required All`. Pour plus d’informations, consultez [Paramètres de stratégie de directive runtime](runtime-directive-policy-settings.md).|  

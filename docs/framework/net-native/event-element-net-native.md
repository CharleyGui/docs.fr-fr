...
---
# <a name="event-element-net-native"></a>\<Élément > d’événement (.NET Native)
...
|---------------|--------------------|-----------------|  
|`Name`|Généralités|Attribut requis. Spécifie le nom de l'événement.|  
...
|Valeur|Description|  
|-----------|-----------------|  
|*paramètre_stratégie*|Paramètre à appliquer à ce type de stratégie pour l'événement. Les valeurs possibles sont `Auto`, `Excluded`, `Included` et `Required`. Pour plus d’informations, consultez [Paramètres de stratégie de directive runtime](runtime-directive-policy-settings.md).|  

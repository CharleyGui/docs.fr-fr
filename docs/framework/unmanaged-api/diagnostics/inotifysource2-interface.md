...
|Méthode|Description|  
|------------|-----------------|  
|[SetNotifyFilter, méthode](../../../../docs/framework/unmanaged-api/diagnostics/inotifysource2-setnotifyfilter-method.md)|Affecte un filtre de notification à utiliser avec cette source.|  

...
---
# <a name="icordebugeditandcontinueerrorinfogeterrorcode-method"></a>ICorDebugEditAndContinueErrorInfo::GetErrorCode, méthode

`GetErrorCode` est obsolète. N'appelez pas cette méthode.  

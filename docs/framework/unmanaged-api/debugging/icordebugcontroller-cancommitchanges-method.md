...
---
# <a name="icordebugcontrollercancommitchanges-method"></a>ICorDebugController::CanCommitChanges, méthode

`CanCommitChanges` est obsolète. N'appelez pas cette méthode.

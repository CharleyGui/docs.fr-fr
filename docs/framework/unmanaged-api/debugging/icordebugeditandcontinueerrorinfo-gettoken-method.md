...
ms.locfileid: "95721411"
---
# <a name="icordebugeditandcontinueerrorinfogettoken-method"></a>ICorDebugEditAndContinueErrorInfo::GetToken, méthode

`GetToken` est obsolète. N'appelez pas cette méthode.  

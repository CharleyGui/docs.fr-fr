...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](icordebugframeenum-next-method.md)|Obtient le nombre d' `ICorDebugFrame` instances spécifié à partir de l’énumération, en commençant à la position actuelle.|  

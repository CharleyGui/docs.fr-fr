...
ms.locfileid: "95722958"
---
# <a name="icordebugeditandcontinuesnapshotsetpebytes-method"></a>ICorDebugEditAndContinueSnapshot::SetPEBytes, méthode

`SetPEBytes` est obsolète. N'appelez pas cette méthode.  

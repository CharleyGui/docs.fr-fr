---
title: ICorDebugErrorInfoEnum::Next, méthode
ms.date: 03/30/2017
api_name:
...
---
# <a name="icordebugerrorinfoenumnext-method"></a>ICorDebugErrorInfoEnum::Next, méthode
`ICorDebugErrorInfoEnum::Next` est obsolète. N'appelez pas cette méthode.  

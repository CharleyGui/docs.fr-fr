...
## <a name="remarks"></a>Notes  
 Un membre de l’énumération `CorDebugRecordFormat` est passé à la méthode [DecodeEvent](icordebugprocess6-decodeevent-method.md) pour indiquer le format du tableau d’octets dans son argument `pRecord`.  

...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](icordebugbreakpointenum-next-method.md)|Obtient le nombre spécifié d’instances de `ICorDebugBreakpoint` à partir de l’énumération, en commençant à la position actuelle.|  

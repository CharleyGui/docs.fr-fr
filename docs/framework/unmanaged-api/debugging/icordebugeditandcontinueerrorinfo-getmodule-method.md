...
ms.locfileid: "95721437"
---
# <a name="icordebugeditandcontinueerrorinfogetmodule-method"></a>ICorDebugEditAndContinueErrorInfo::GetModule, méthode

`GetModule` est obsolète. N'appelez pas cette méthode.  

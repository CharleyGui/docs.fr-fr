...
ms.locfileid: "95721450"
---
# <a name="icordebugeditandcontinuesnapshotcopymetadata-method"></a>ICorDebugEditAndContinueSnapshot::CopyMetaData, méthode

`CopyMetaData` est obsolète. N'appelez pas cette méthode.  

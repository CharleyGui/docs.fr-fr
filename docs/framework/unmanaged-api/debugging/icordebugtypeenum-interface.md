...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](icordebugtypeenum-next-method.md)|Obtient le nombre spécifié d’instances de `ICorDebugType` à partir de l’énumération, en commençant à la position actuelle.|  

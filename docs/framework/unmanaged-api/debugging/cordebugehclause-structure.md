...
## <a name="remarks"></a>Notes  
 Un tableau de valeurs de `CoreDebugEHClause` est retourné par la méthode [getehclauses,](../../../../docs/framework/unmanaged-api/debugging/icordebugilcode-getehclauses-method.md) .  

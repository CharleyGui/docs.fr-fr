...
---
# <a name="icordebugeditandcontinueerrorinfo-interface"></a>ICorDebugEditAndContinueErrorInfo, interface
`ICorDebugEditAndContinueErrorInfo` est obsolète. N'utilisez pas cette interface.  

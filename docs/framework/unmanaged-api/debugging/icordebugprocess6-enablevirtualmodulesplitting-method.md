...
## <a name="terminology"></a>Terminologie  
 ...
 Les modules conteneurs et les sous-modules sont représentés par des objets de l'interface ICorDebugModule. Toutefois, le comportement de l’interface est légèrement différent dans chaque cas, comme décrit dans la \<x-ref to section> section.  

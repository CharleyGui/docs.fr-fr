...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](icordebugmoduleenum-next-method.md)|Obtient le nombre spécifié d’instances de `ICorDebugModule` à partir de l’énumération, en commençant à la position actuelle.|  

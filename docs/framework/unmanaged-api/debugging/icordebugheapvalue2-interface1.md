...
|Méthode|Description|  
|------------|-----------------|  
|[CreateHandle, méthode](../../../../docs/framework/unmanaged-api/debugging/icordebugheapvalue2-createhandle-method.md)|Crée un handle du type spécifié pour cet `ICorDebugHeapValue2` objet.|  

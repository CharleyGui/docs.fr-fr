...
|Méthode|Description|  
|------------|-----------------|  
|[Next, méthode](icordebugassemblyenum-next-method.md)|Obtient le nombre spécifié d’instances de `ICorDebugAssembly` dans l’énumération, en démarrant à partir de la position actuelle.|  

...
`ppNewInstance`  
à Reçoit le pointeur vers la nouvelle instance de la classe. Si une erreur se produit, aucun nouvel objet n’est retourné et `ppNewInstance` reste inchangé.

...
## <a name="parameters"></a>Paramètres  
 `suspendReason`  
 dans Valeur de l’énumération [COR_PRF_SUSPEND_REASON](../../../../docs/framework/unmanaged-api/profiling/cor-prf-suspend-reason-enumeration.md) qui indique la raison de la suspension.  

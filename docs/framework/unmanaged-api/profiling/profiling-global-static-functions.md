...
## <a name="net-framework-version-4-profiling-functions"></a>.NET Framework les fonctions de profilage de la version 4  
 ...
 `FunctionIDMapper2` étend la fonction [FunctionIDMapper](functionidmapper-function.md) avec un `clientData` paramètre, que les profileurs peuvent utiliser pour lever l’ambiguïté entre les runtimes.  

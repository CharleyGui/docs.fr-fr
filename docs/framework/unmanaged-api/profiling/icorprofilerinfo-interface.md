...
|[GetClassFromObject, méthode](../../../../docs/framework/unmanaged-api/profiling/icorprofilerinfo-getclassfromobject-method.md)|Obtient le `ClassID` d’un<br /><br /> objet, en fonction de son `ObjectID`.|  

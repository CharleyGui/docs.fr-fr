...
|Méthode|Description|  
|------------|-----------------|  
|[MarkToken, méthode](../../../../docs/framework/unmanaged-api/metadata/ihostfilter-marktoken-method.md)|Indicates that the specified metadata token will be processed.|  

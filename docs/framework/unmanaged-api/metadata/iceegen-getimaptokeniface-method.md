...
ms.locfileid: "67746142"
---
# <a name="iceegengetimaptokeniface-method"></a>ICeeGen::GetIMapTokenIface, méthode
...
## <a name="parameters"></a>Paramètres  
 `pIMapToken`  
 [in, out] Le jeton de métadonnées pour l’interface à retourner.  

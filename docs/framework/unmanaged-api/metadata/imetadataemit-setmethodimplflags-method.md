...
## <a name="parameters"></a>Paramètres  
 ...
 `dwImplFlags`  
 dans Combinaison des valeurs de l’énumération [CorMethodImpl,](../../../../docs/framework/unmanaged-api/metadata/cormethodimpl-enumeration.md) qui spécifie les fonctionnalités d’implémentation de la méthode.  

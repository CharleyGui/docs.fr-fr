...
|`NATIVE_TYPE_CURRENCY`|Type COM numérique qui correspond au type de <xref:System.Decimal> managé.|  
...
|`NATIVE_TYPE_IINSPECTABLE`|Type de `IInspectable` natif.|  
|`NATIVE_TYPE_HSTRING`|`HString`natif.|  

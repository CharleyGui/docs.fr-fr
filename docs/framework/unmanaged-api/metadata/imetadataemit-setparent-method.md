...
## <a name="parameters"></a>Paramètres  
 `mr`  
 [dans] Le `mdMemberRef` jeton pour recevoir un nouveau parent.  
  
 `tk`  
 [dans] Le `mdToken` pour le nouveau parent.  

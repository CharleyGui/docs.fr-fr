...
## <a name="parameters"></a>Paramètres  
 `mr`  
 dans Jeton `mdMemberRef` pour recevoir un nouveau parent.  
  
 `tk`  
 dans `mdToken` du nouveau parent.  

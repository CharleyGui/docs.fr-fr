...
Termine l’emprunt d’identité de l’identité de l’utilisateur actuel et retourne le jeton de thread d’origine.  
...
## <a name="remarks"></a>Remarques  
 ...
 `RevertToSelf` est appelé pour retourner au jeton de thread d’origine, après un appel antérieur à la méthode [ImpersonateLoggedOnUser](ihostsecuritymanager-impersonateloggedonuser-method.md) .  

...
|E_INVALIDARG|`dwConnectionId` était égal à zéro, ou `BeginConnection` a déjà été appelé à l’aide de cette valeur de `dwConnectionId`, ou `szConnectionName` était null.|  

...
Obtient un pointeur d’interface vers une instance d' [IHostMalloc](../../../../docs/framework/unmanaged-api/hosting/ihostmalloc-interface.md) qui est utilisé pour effectuer des demandes d’allocation à partir d’un tas créé par l’hôte.  
...
## <a name="parameters"></a>Paramètres  
 `dwMallocType`  
 dans Combinaison d’indicateurs [MALLOC_TYPE](../../../../docs/framework/unmanaged-api/hosting/malloc-type-enumeration.md) qui spécifie les caractéristiques de la mémoire qui est allouée.  
  
 `ppMAlloc`  
 à Pointeur vers l’adresse d’une instance de `IHostMAlloc` fournie par l’hôte.  

...
Demande à l’common language runtime (CLR) d’associer la valeur d’identificateur spécifiée à la tâche représentée par l’instance d' [ICLRTask](../../../../docs/framework/unmanaged-api/hosting/iclrtask-interface.md) actuelle.  
...
## <a name="parameters"></a>Paramètres  
 `Asked`  
 dans Identificateur unique de l’common language runtime à associer à la tâche représentée par l’instance de `ICLRTask` actuelle.  

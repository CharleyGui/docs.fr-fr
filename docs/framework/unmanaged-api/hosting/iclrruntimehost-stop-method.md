...
---
# <a name="iclrruntimehoststop-method"></a>ICLRRuntimeHost::Stop, méthode

Arrête l’exécution du code par le common language runtime (CLR).  
  
> [!IMPORTANT]
> Cette méthode ne libère pas les ressources de l’hôte, ne décharge pas les domaines d’application ou ne détruit pas les threads. Vous devez terminer le processus pour libérer ces ressources.  
...
|HRESULT|Description|  
|-------------|-----------------|  
|S_OK|`Stop` retourné avec succès.|  

...
Obtient un pointeur d’interface vers une instance [ICLRAssemblyReferenceList](../../../../docs/framework/unmanaged-api/hosting/iclrassemblyreferencelist-interface.md) à partir de la liste d’identités d’assembly partielle fournie.  
...
## <a name="parameters"></a>Paramètres  
 ...
 `ppReferenceList`  
 à Pointeur d’interface vers un objet `ICLRAssemblyReferenceList` qui contient les données d’identité de l’assembly pour la liste des assemblys spécifiés dans `ppwzAssemblyReferences`.  

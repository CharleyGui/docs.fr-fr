...
## <a name="remarks"></a>Notes  
 Les objets de section critique fournissent une synchronisation similaire à celle fournie par un objet mutex, sauf que les sections critiques peuvent être utilisées uniquement par les threads d’un processus unique. `CreateCrst`reflète la fonction `InitializeCriticalSection` Win32.  

...
## <a name="remarks"></a>Notes  
 Un hôte appelle `RudeAbort` pour abandonner immédiatement une tâche. Les finaliseurs et les routines de gestion des exceptions ne sont pas garantis pour être exécutée.  

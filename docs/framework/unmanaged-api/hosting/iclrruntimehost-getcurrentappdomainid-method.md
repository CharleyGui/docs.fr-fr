...
Obtient l’identificateur numérique du <xref:System.AppDomain> en cours d’exécution.  
...
## <a name="parameters"></a>Paramètres  
 `pdwAppDomainId`  
 à Identificateur numérique de l' <xref:System.AppDomain> en cours d’exécution.  
...
## <a name="remarks"></a>Notes  
 Le paramètre `pdwAppDomainId` est défini sur la valeur de la propriété <xref:System.AppDomain.Id%2A> du <xref:System.AppDomain> dans lequel le thread actuel s’exécute.  

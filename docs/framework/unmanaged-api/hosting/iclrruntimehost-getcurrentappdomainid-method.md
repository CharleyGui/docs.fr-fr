...
Obtient l’identificateur numérique du en <xref:System.AppDomain> cours d’exécution.  
...
## <a name="parameters"></a>Paramètres  
 ...
 `pdwAppDomainId`  
 à Identificateur numérique du en cours d' <xref:System.AppDomain> exécution.  
...
## <a name="remarks"></a>Remarques  
 ...
 Le `pdwAppDomainId` paramètre est défini sur la valeur de la <xref:System.AppDomain.Id%2A> propriété du <xref:System.AppDomain> dans lequel le thread actuel s’exécute.  

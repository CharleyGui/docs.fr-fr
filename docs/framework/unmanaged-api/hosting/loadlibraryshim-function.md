...
|CLR_E_SHIM_RUNTIMELOAD|Le `szDllName` chargement requiert le chargement du Common Language Runtime (CLR) et la version nécessaire du CLR ne peut pas être chargée.|  

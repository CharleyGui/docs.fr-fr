...
## <a name="parameters"></a>Paramètres  
 `dwStartupFlags`  
 dans Indicateurs de démarrage de l’hôte à définir. Utilisez les mêmes indicateurs qu’avec les fonctions [CorBindToRuntimeEx](../../../../docs/framework/unmanaged-api/hosting/corbindtoruntimeex-function.md) et [CorBindToRuntimeHost](corbindtoruntimehost-function.md) .  

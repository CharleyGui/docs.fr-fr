...
---
# <a name="clear-element-for-configsections"></a>\<clear>, élément de \<configSections>
...
L' **\<clear>** élément supprime tous les sections et groupes de sections de votre application qui ont été définis précédemment dans le fichier de configuration actuel ou à un niveau supérieur dans la hiérarchie des fichiers de configuration.

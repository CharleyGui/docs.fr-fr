...
[\<system.identityModel>](system-identitymodel.md)Fournit la configuration permettant d’activer les options WIF dans les applications.  
  
[\<system.identityModel.services>](system-identitymodel-services.md)Fournit la configuration pour la Fédération passive à l’aide de WIF. Configure le module d’authentification de session (SAM) et le module d’authentification fédérée (WSFAM).

...
|---------------|-----------------|  
|value|Chaîne qui spécifie l’URI qui représente le type de revendication de la revendication à utiliser pour la <xref:System.Security.Principal.IIdentity.Name%2A> propriété. Obligatoire.|  

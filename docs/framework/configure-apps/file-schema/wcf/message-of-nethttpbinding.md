...
---
# <a name="message-of-nethttpbinding"></a>\<> de message de \<netHttpBinding >
Définit les paramètres pour la sécurité au niveau du message de la [\<NetHttpBinding](nethttpbinding.md).  

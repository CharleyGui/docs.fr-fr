...
|Élément|Description|  
|-------------|-----------------|  
|[\<filters>](filters-of-routing.md)|Mappages entre les filtres de routage et les points de terminaison cibles auxquels envoyer des messages lorsque le filtre correspond.|  

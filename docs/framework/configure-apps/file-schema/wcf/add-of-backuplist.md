...
|Élément|Description|  
|-------------|-----------------|  
|[\<routing>](routing.md)|Contient une liste de points de terminaison à utiliser par le service de routage au cas où il est impossible d'atteindre le point de terminaison primaire.|  

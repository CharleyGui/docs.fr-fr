...
---
# <a name="scopedcertificates-element"></a>Élément \<scopedCertificates>
...
## <a name="example"></a>Exemple  
 ...
 L’exemple suivant spécifie un certificat de service que le client doit utiliser lors de la communication avec les points de terminaison dont le nom de domaine se trouve `http://www.contoso.com` sur le protocole http.  

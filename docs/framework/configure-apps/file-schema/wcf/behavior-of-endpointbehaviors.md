...
---
# <a name="behavior-of-endpointbehaviors"></a>\<> de comportement de \<endpointBehaviors >
...
|[\<enableWebScript >](enablewebscript.md)|Active le comportement de point de terminaison qui permet de consommer le service à partir de pages Web ASP.NET AJAX. Le comportement doit être utilisé uniquement avec la \<webHttpBinding > liaison standard ou l’élément de liaison \<webMessageEncoding >.|  

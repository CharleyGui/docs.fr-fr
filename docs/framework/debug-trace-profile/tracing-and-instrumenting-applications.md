...
- **Compteurs de performance** : composants qui vous permettent de suivre les performances de votre application. Pour plus d’informations, consultez [Compteurs de performances](performance-counters.md).  

...
## <a name="servers-and-clients"></a>Serveurs et clients  
 Dans Active Accessibility, les serveurs et les clients communiquent directement, en grande partie via `IAccessible`l’implémentation du serveur de.  
...
## <a name="roles-and-control-types"></a>Rôles et types de contrôle  
 ...
 Le tableau suivant montre le mappage des rôles de Active Accessibility [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] aux types de contrôle.  
...
## <a name="states-and-properties"></a>États et propriétés  
 Dans Active Accessibility, les éléments prennent en charge un ensemble commun de propriétés et certaines propriétés ( `accState`telles que) doivent décrire des choses très différentes, en fonction du rôle de l’élément. Les serveurs doivent implémenter toutes les méthodes de `IAccessible` qui retournent une propriété, y compris celles qui ne sont pas pertinentes pour l’élément.  
...
|STATE_SYSTEM_UNAVAILABLE|<xref:System.Windows.Automation.AutomationElement.IsEnabledProperty>|Y|  
 ...
 Les États suivants n’ont pas été implémentés par la plupart des serveurs de contrôle Active Accessibility [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)]ou n’ont aucun équivalent dans.  
...
## <a name="events"></a>Events  
 ...
 Le tableau suivant montre la correspondance entre Active Accessibility WinEvents et [!INCLUDE[TLA2#tla_uiautomation](../../../includes/tla2sharptla-uiautomation-md.md)] les événements.  

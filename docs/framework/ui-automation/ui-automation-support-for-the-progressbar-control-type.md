...
|<xref:System.Windows.Automation.Provider.IValueProvider.Value%2A>|Consultez les notes.|Cette propriété expose la progression textuelle d’un contrôle de barre de progression.|  

...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Barre de progression|Cette valeur est identique pour toutes les infrastructures d’interface utilisateur.|  
...
|---------------------------------------|--------------------|-----------|  
|<xref:System.Windows.Automation.Provider.IValueProvider>|Dépend|Les contrôles de barre de progression qui donnent une indication textuelle de la progression doivent implémenter <xref:System.Windows.Automation.Provider.IValueProvider>.|  
...
|<xref:System.Windows.Automation.Provider.IRangeValueProvider>|Dépend|Les contrôles de barre de progression qui utilisent une plage numérique doivent implémenter <xref:System.Windows.Automation.Provider.IRangeValueProvider>|  

...
Pour plus d'informations sur ce sujet, consultez [UI Automation d'un contrôle personnalisé WPF](/dotnet/desktop/wpf/controls/ui-automation-of-a-wpf-custom-control).

...
|------------------|------------------|  
|Button<br /><br /> -Image (0 ou plus)<br />-Text (0 ou plus)|Button|  
...
|<xref:System.Windows.Automation.AutomationElementIdentifiers.ControlTypeProperty>|Button|Cette valeur est identique pour toutes les infrastructures d’interface utilisateur.|  

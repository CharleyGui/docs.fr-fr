...
<a name="introduction"></a>Cette vue d’ensemble fournit une introduction aux topologies [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)]de navigation dans. Trois topologies de navigation courantes, avec des exemples, sont abordées dans cet article.  
  
> [!NOTE]
> Avant de lire cette rubrique, vous devez être familiarisé avec le concept de navigation structurée dans [!INCLUDE[TLA2#tla_wpf](../../../../includes/tla2sharptla-wpf-md.md)] utilisation des fonctions de page. Pour plus d’informations sur ces deux rubriques, consultez [vue d’ensemble](structured-navigation-overview.md)de la navigation structurée.  
...
## <a name="navigation-topologies"></a>Topologies de navigation  
 ...
 Cette rubrique couvre trois topologies de navigation courantes: *fixed linéaire*, *fixed Hierarchical*et *générée dynamiquement*. Chaque topologie de navigation est illustrée par un exemple qui [!INCLUDE[TLA2#tla_ui](../../../../includes/tla2sharptla-ui-md.md)] est semblable à celui illustré dans la figure suivante:  

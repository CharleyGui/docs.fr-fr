...
Rectangle peint à l’aide d’un SolidColorBrush  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.SolidColorBrush> classe, consultez [vue d’ensemble de la peinture avec des couleurs unies et des dégradés](painting-with-solid-colors-and-gradients-overview.md).  
  
<a name="paintwithlineargradientbrush"></a>
## <a name="paint-with-a-linear-gradient"></a>Peindre avec un dégradé linéaire  
 <xref:System.Windows.Media.LinearGradientBrush>Peint une zone avec un dégradé linéaire. Un dégradé linéaire fusionne deux couleurs ou plus sur une ligne, l’axe du dégradé. Les <xref:System.Windows.Media.GradientStop> objets vous permettent de spécifier les couleurs du dégradé et leurs positions.  
...
Rectangle peint à l’aide d’un LinearGradientBrush  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.LinearGradientBrush> classe, consultez [vue d’ensemble de la peinture avec des couleurs unies et des dégradés](painting-with-solid-colors-and-gradients-overview.md).  
  
<a name="paintwithradialgradientbrush"></a>
## <a name="paint-with-a-radial-gradient"></a>Peindre avec un dégradé radial  
 <xref:System.Windows.Media.RadialGradientBrush>Peint une zone avec un dégradé radial. Un dégradé radial fusionne deux couleurs ou plus sur un cercle. Comme pour la <xref:System.Windows.Media.LinearGradientBrush> classe, vous utilisez des <xref:System.Windows.Media.GradientStop> objets pour spécifier les couleurs du dégradé et leurs positions.  
...
Rectangle peint à l’aide d’un RadialGradientBrush  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.RadialGradientBrush> classe, consultez [vue d’ensemble de la peinture avec des couleurs unies et des dégradés](painting-with-solid-colors-and-gradients-overview.md).  
  
<a name="paintwithimage"></a>
## <a name="paint-with-an-image"></a>Peindre avec une image  
 <xref:System.Windows.Media.ImageBrush>Peint une zone avec un <xref:System.Windows.Media.ImageSource> .  
...
Rectangle peint à l’aide d’une image  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.ImageBrush> classe, consultez [peinture avec des images, des dessins et](painting-with-images-drawings-and-visuals.md)des éléments visuels.  
...
Rectangle peint à l’aide d’un DrawingBrush  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.DrawingBrush> classe, consultez [peinture avec des images, des dessins et](painting-with-images-drawings-and-visuals.md)des éléments visuels.  
  
<a name="paintwithvisual"></a>
## <a name="paint-with-a-visual"></a>Peindre avec un visuel  
 <xref:System.Windows.Media.VisualBrush>Peint une zone avec un <xref:System.Windows.Media.Visual> objet. , Et sont des exemples d’objets visuels <xref:System.Windows.Controls.Button> <xref:System.Windows.Controls.Page> <xref:System.Windows.Controls.MediaElement> . Un <xref:System.Windows.Media.VisualBrush> vous permet également de projeter du contenu d’une partie de votre application dans une autre zone. il est très utile pour créer des effets de reflet et des parties de l’écran.  
...
Rectangle peint à l’aide d’un VisualBrush  
 ...
 Pour plus d’informations sur la <xref:System.Windows.Media.VisualBrush> classe, consultez [peinture avec des images, des dessins et](painting-with-images-drawings-and-visuals.md)des éléments visuels.  
...
- Pour obtenir la liste des pinceaux prédéfinis disponibles, consultez la <xref:System.Windows.Media.Brushes> classe. Pour obtenir un exemple illustrant l’utilisation d’un pinceau prédéfini, consultez [peindre une zone avec une couleur unie](how-to-paint-an-area-with-a-solid-color.md).  
...
## <a name="common-brush-features"></a>Fonctionnalités courantes du pinceau  
 <xref:System.Windows.Media.Brush>les objets fournissent une <xref:System.Windows.Media.Brush.Opacity%2A> propriété qui peut être utilisée pour rendre un pinceau transparent ou partiellement transparent. <xref:System.Windows.Media.Brush.Opacity%2A>La valeur 0 rend un pinceau complètement transparent, tandis qu’une <xref:System.Windows.Media.Brush.Opacity%2A> valeur de 1 rend un pinceau entièrement opaque. L’exemple suivant utilise la <xref:System.Windows.Media.Brush.Opacity%2A> propriété pour rendre un <xref:System.Windows.Media.SolidColorBrush> opaque de 25%.  
...
> [!NOTE]
> Il est plus efficace de modifier la valeur d’opacité d’un pinceau que de modifier l’opacité d’un élément entier à l’aide de sa <xref:System.Windows.UIElement.Opacity%2A?displayProperty=nameWithType> propriété.  
  
 Vous pouvez faire pivoter, mettre à l’échelle, incliner et traduire le contenu d’un pinceau à l’aide de ses <xref:System.Windows.Media.Brush.Transform%2A> <xref:System.Windows.Media.Brush.RelativeTransform%2A> Propriétés ou. Pour plus d’informations, consultez [vue d’ensemble](brush-transformation-overview.md)de la transformation de pinceau.  
  
 Étant donné qu’il s’agit d' <xref:System.Windows.Media.Animation.Animatable> objets, les <xref:System.Windows.Media.Brush> objets peuvent être animés. Pour plus d’informations, consultez [vue d’ensemble](animation-overview.md)de l’animation.  
  
<a name="freezable_features"></a>
### <a name="freezable-features"></a>Fonctionnalités Freezable  
 Comme elle hérite de la <xref:System.Windows.Freezable> classe, la <xref:System.Windows.Media.Brush> classe fournit plusieurs fonctionnalités spéciales : les <xref:System.Windows.Media.Brush> objets peuvent être déclarés en tant que [ressources](../../../desktop-wpf/fundamentals/xaml-resources-define.md), partagés entre plusieurs objets et clonés. En outre, tous les <xref:System.Windows.Media.Brush> types sauf <xref:System.Windows.Media.VisualBrush> peuvent être mis en lecture seule pour améliorer les performances et rendre thread-safe.  
  
 Pour plus d’informations sur les différentes fonctionnalités fournies par les <xref:System.Windows.Freezable> objets, consultez [vue d’ensemble des objets Freezable](../advanced/freezable-objects-overview.md).  
  
 Pour plus d’informations sur la raison pour laquelle <xref:System.Windows.Media.VisualBrush> les objets ne peuvent pas être figés, consultez la <xref:System.Windows.Media.VisualBrush> page type.  
...
- [Rubriques de procédures](brushes-how-to-topics.md)

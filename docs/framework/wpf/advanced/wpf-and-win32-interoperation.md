...
- Créer un C# exécutable pour le contenu de la[!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)]et faire référence à une C++ dll qui contient le contenu[!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].
...
2. Dérivez de <xref:System.Windows.Interop.HwndHost> pour créer un objet qui contient votre contenu [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].
...
- En général, alors que les appareils d’entrée sont étendus au sein de la région de [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)] hébergée <xref:System.Windows.Interop.HwndHost>, les événements d’entrée sont directement dirigés vers [!INCLUDE[TLA2#tla_win32](../../../../includes/tla2sharptla-win32-md.md)].

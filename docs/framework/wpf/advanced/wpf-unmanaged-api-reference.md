...
---
# <a name="wpf-unmanaged-api-reference"></a>Informations de référence sur les API non managées WPF
Les bibliothèques Windows Presentation Foundation (WPF) exposent un certain nombre de fonctions non managées destinées à un usage interne uniquement. Elles ne doivent pas être appelées à partir du code utilisateur.  

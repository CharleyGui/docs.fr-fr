 ...
 **Remarque** Par souci de simplicité, l’exemple ci-dessus utilise \*la présence d’une extension. XPS comme test pour qu’un fichier soit XPS. Toutefois, les fichiers XPS n’ont pas besoin d’avoir cette extension. [IsXPS. exe (outil de conformité isXPS)](https://docs.microsoft.com/previous-versions/dotnet/netframework-4.0/aa348104(v=vs.100)) est une façon de tester la validité d’un fichier XPS.  

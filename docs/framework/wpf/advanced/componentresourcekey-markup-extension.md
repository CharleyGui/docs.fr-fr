...
|||  
|-|-|  
|`targetTypeName`|Nom du type public [!INCLUDE[TLA#tla_clr](../../../../includes/tlasharptla-clr-md.md)] qui est défini dans l’assembly de ressource.|  

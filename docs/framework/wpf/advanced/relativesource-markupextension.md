...
Spécifie les propriétés d’une <xref:System.Windows.Data.RelativeSource> source de liaison à utiliser dans une [extension de balisage de liaison](binding-markup-extension.md), ou lors de la définition de la <xref:System.Windows.Data.Binding.RelativeSource%2A> propriété d’un <xref:System.Windows.Data.Binding> élément établi en XAML.
...
Dans l' [!INCLUDE[TLA2#tla_winclient](../../../../includes/tla2sharptla-winclient-md.md)] implémentation du processeur XAML, la gestion de cette extension de balisage est définie par la <xref:System.Windows.Data.RelativeSource> classe.

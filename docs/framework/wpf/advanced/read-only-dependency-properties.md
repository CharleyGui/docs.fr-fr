...
- Lors de l’inscription de votre propriété, appelez la méthode <xref:System.Windows.DependencyProperty.RegisterReadOnly%2A> à la place de la méthode <xref:System.Windows.DependencyProperty.Register%2A> normale pour l’inscription des propriétés.  

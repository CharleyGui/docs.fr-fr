...
## <a name="documentviewer-parts"></a>Parties DocumentViewer  
 Le tableau suivant répertorie les parties nommées du contrôle <xref:System.Windows.Controls.DocumentViewer>.  
  
|Élément|Type|Description|  
|-|-|-|  
|PART_ContentHost|<xref:System.Windows.Controls.ScrollViewer>|Contenu et zone de défilement.|  
|PART_FindToolBarHost|<xref:System.Windows.Controls.ContentControl>|Par défaut, la zone de recherche est située en bas.|  
  
## <a name="documentviewer-states"></a>États de DocumentViewer  
 Le tableau suivant répertorie les États visuels du contrôle <xref:System.Windows.Controls.DocumentViewer>.  
...
## <a name="documentviewer-controltemplate-example"></a>DocumentViewer ControlTemplate, exemple  
 L’exemple suivant montre comment définir une <xref:System.Windows.Controls.ControlTemplate> pour le contrôle <xref:System.Windows.Controls.DocumentViewer>.  

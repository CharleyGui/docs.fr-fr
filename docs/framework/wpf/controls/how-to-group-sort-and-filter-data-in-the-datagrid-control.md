...
3. Dans XAML, créez une instance de la classe <xref:System.Windows.Data.CollectionViewSource>, définissez la [directive x :Key](../../../desktop-wpf/xaml-services/xkey-directive.md)et définissez l’instance de votre classe de collection comme <xref:System.Windows.Data.CollectionViewSource.Source%2A>.

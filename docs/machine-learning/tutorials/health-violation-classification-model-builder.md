...
1. Créez une  **C# application console .net Core** appelée « RestaurantViolations ».
...
- [Métriques du modèle de classification multiclasse](../resources/metrics.md#metrics-for-multi-class-classification)

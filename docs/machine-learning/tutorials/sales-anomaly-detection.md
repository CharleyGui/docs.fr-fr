...
1. Utilisez le code suivant pour itérer au sein du `IEnumerable` `predictions` et afficher les résultats :
...
1. Itérez au sein du `IEnumerable` `predictions` et affichez les résultats avec le code suivant :

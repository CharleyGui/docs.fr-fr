...
- [Obtenez Visual Basic](https://visualstudio.microsoft.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=inline+link&utm_content=download+vs2019) Fournit des liens de téléchargement pour les versions Visual Studio qui viennent avec le support Visual Basic, y compris les versions gratuites.
...
- [Exemples](https://github.com/dotnet/docs/tree/master/samples/snippets/visualbasic) Fournit des liens vers un exemple de code en Visual Basic.

...
## <a name="arguments"></a>Arguments  
 `+` &#124; `-`  
 Facultatif. La spécification de `-verbose` est identique à la spécification de `-verbose+` , ce qui amène le compilateur à émettre des messages détaillés. La valeur par défaut de cette option est `-verbose-` .  

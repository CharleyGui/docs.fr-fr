...
|[-optimiser](optimize.md)|Active/désactive les optimisations.|  
...
|[-cible](target.md)|Spécifie le format de la sortie.|  
...
|[-keyfile](keyfile.md)|Spécifie un fichier contenant une clé ou une paire de clés afin d'attribuer un nom fort à un assembly.|  
...
|[-optionstrict](optionstrict.md)|Applique une sémantique de type stricte.|  

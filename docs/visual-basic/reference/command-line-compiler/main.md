...
## <a name="example"></a>Exemple  
 Le code suivant compile `T2.vb` et `T3.vb`, en spécifiant que la procédure `Sub Main` sera trouvée dans la classe `Test2`.  
...
- [Procédure principale dans Visual Basic](../../../visual-basic/programming-guide/program-structure/main-procedure.md)

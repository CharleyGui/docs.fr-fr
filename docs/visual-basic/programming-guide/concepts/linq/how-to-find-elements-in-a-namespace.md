...
---
# <a name="how-to-find-elements-in-a-namespace-xpath-linq-to-xml-visual-basic"></a>Procédure : Rechercher des éléments dans un espace de noms (XPath-LINQ to XML) (Visual Basic)

---
title: Opérations de génération
ms.date: 07/20/2015
...
ms.locfileid: "74353392"
---
# <a name="generation-operations-visual-basic"></a>Generation Operations (Visual Basic)
La génération fait référence à la création d’une nouvelle séquence de valeurs.  
  
 Les méthodes d’opérateurs de requête standard qui effectuent des opérations de génération sont répertoriées dans la section suivante.  
...
|Range|Génère une collection qui contient une séquence de nombres.|Non applicable.|<xref:System.Linq.Enumerable.Range%2A?displayProperty=nameWithType>|  

...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Relations des types dans des opérations de requête (Visual Basic)](type-relationships-in-query-operations.md)  
...
## <a name="related-sections"></a>Sections connexes  
 ...
 [Prise en charge de LINQ par les outils et l’IDE Visual Studio (Visual Basic)](visual-studio-ide-and-tools-support-for-linq.md)  
 ...
 Fournit des liens vers des rubriques sur l’utilisation de LINQ en C#.

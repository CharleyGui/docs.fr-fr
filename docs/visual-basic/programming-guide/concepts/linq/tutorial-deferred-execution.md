---
title: 'Didacticiel : exécution différée'
ms.date: 07/20/2015
...
---
# <a name="tutorial-deferred-execution-visual-basic"></a>Didacticiel : exécution différée (Visual Basic)
...
|-----------|-----------------|  
|[Exécution et évaluation différées en LINQ to XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/deferred-execution-and-lazy-evaluation-in-linq-to-xml.md)|Décrit les concepts d'évaluation et d'exécution différées.|  
|[Exemple d’exécution différée (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/deferred-execution-example.md)|Fournit un exemple d'exécution différée.|  

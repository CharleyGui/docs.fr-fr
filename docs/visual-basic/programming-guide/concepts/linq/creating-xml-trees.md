...
|[Introduction aux littéraux XML dans Visual Basic](../../../../visual-basic/programming-guide/concepts/linq/introduction-to-xml-literals.md)|Fournit une introduction rapide à la création d’arborescences dans Visual Basic à l’aide de littéraux XML. Cette rubrique contient des liens vers la documentation Visual Basic des littéraux XML.|  
...
|[Analyse XML (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/parsing-xml.md)|Montre comment analyser du code XML provenant de diverses sources. [!INCLUDE[sqltecxlinq](~/includes/sqltecxlinq-md.md)] se situe par-dessus <xref:System.Xml.XmlReader>, qui est utilisé pour analyser le code XML.|  
...
|[Procédure : valider à l’aide de XSD (LINQ to XML) (Visual Basic)](../../../../visual-basic/programming-guide/concepts/linq/how-to-validate-using-xsd-linq-to-xml.md)|Montre comment valider une arborescence XML à l’aide de XSD.|  

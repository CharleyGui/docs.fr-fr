...
---
# <a name="how-to-modify-expression-trees-visual-basic"></a>Procédure : Modifier les arborescences d’expressions (Visual Basic)
...
5. Ajoutez du code à `Main` la méthode dans le fichier Module1. vb pour créer une arborescence d’expressions et la passer à la méthode qui la modifiera.
...
- [Guide pratique pour Exécuter les arborescences d’expressions (Visual Basic)](../../../../visual-basic/programming-guide/concepts/expression-trees/how-to-execute-expression-trees.md)

...
## <a name="my"></a>My  
 La fonctionnalité `My` offre un accès facile et intuitif à un certain nombre de .NET Framework classes, ce qui permet à l’utilisateur Visual Basic d’interagir avec l’ordinateur, l’application, les paramètres, les ressources, etc.  

...
## <a name="in-this-section"></a>Dans cette section  
 ...
 [Guide pratique pour référencer les objets COM à partir de Visual Basic](how-to-reference-com-objects.md)  
 Décrit la procédure à suivre pour ajouter des références aux objets COM qui ont des bibliothèques de types.  
  
 [Procédure : Utiliser les contrôles ActiveX](how-to-work-with-activex-controls.md)  
 ...
 [Procédure : Appeler des API Windows](how-to-call-windows-apis.md)  

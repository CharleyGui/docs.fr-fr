...
|[Résumé](../../../language-reference/data-types/short-data-type.md)|`Short`, `Integer`, `Long`, `Decimal`, `Single`, `Double`|  
...
|[Unique](../../../language-reference/data-types/single-data-type.md)|`Single`, `Double`|  
...
|[Nothing](../../../language-reference/nothing.md)|Tout type de données ou type d’objet.|  

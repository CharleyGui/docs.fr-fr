...
Une clause ou une `Aggregate` clause est nécessaire pour commencer une requête. [ `From` ](../../../../visual-basic/language-reference/queries/from-clause.md) Une clause `From` spécifie une collection de sources et une variable d'itération pour une requête. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#7](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#7)]

### <a name="select-clause"></a>Select (clause)

facultatif. Une clause déclare un ensemble de variables d’itération pour une requête. [ `Select` ](../../../../visual-basic/language-reference/queries/select-clause.md) Par exemple :
...
facultatif. [ Une`Where` clause](../../../../visual-basic/language-reference/queries/where-clause.md) spécifie une condition de filtrage pour une requête. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#9](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#9)]

### <a name="order-by-clause"></a>Clause ORDER BY]

| Facultatif. [ Une`Order By` clause](../../../../visual-basic/language-reference/queries/order-by-clause.md) spécifie l’ordre de tri des colonnes dans une requête. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#10](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#10)]

### <a name="join-clause"></a>Join (clause)

facultatif. Une clause combine deux collections en une collection unique. [ `Join` ](../../../../visual-basic/language-reference/queries/join-clause.md) Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#11](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#11)]

### <a name="group-by-clause"></a>Group By (clause)

facultatif. [ Une`Group By` clause](../../../../visual-basic/language-reference/queries/group-by-clause.md) regroupe les éléments d’un résultat de requête. Elle peut être utilisée pour appliquer des fonctions d’agrégation à chaque groupe. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#12](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#12)]

### <a name="group-join-clause"></a>Group Join (clause)

facultatif. Une clause combine deux collections en une collection hiérarchique unique. [ `Group Join` ](../../../../visual-basic/language-reference/queries/group-join-clause.md) Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#13](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#13)]

### <a name="aggregate-clause"></a>Aggregate (clause)

Une clause ou une `From` clause est nécessaire pour commencer une requête. [ `Aggregate` ](../../../../visual-basic/language-reference/queries/aggregate-clause.md) Une clause `Aggregate` applique une ou plusieurs fonctions d’agrégation à une collection. Par exemple, vous pouvez utiliser la `Aggregate` clause pour calculer une somme pour tous les éléments retournés par une requête, comme l’illustre l’exemple suivant.
...
facultatif. [ Une`Let` clause](../../../../visual-basic/language-reference/queries/let-clause.md) calcule une valeur et l’assigne à une nouvelle variable dans la requête. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#16](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#16)]

### <a name="distinct-clause"></a>Distinct (clause)

facultatif. Une `Distinct` clause restreint les valeurs de la variable d’itération actuelle pour éliminer les valeurs en double dans les résultats de la requête. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#17](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#17)]

### <a name="skip-clause"></a>Skip (clause)

facultatif. [ Une`Skip` clause](../../../../visual-basic/language-reference/queries/skip-clause.md) ignore un nombre spécifié d’éléments dans une collection, puis retourne les éléments restants. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#18](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#18)]

### <a name="skip-while-clause"></a>SkipWhile (clause)

facultatif. `true` [ Une`Skip While` clause](../../../../visual-basic/language-reference/queries/skip-while-clause.md) ignore les éléments d’une collection tant qu’une condition spécifiée a la valeur, puis retourne les éléments restants. Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#19](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#19)]

### <a name="take-clause"></a>Take (clause)

facultatif. Une clause retourne un nombre spécifié d’éléments contigus à partir du début d’une collection. [ `Take` ](../../../../visual-basic/language-reference/queries/take-clause.md) Par exemple :

 [!code-vb[VbVbalrIntroToLINQ#20](~/samples/snippets/visualbasic/VS_Snippets_VBCSharp/VbVbalrIntroToLINQ/VB/Class1.vb#20)]

### <a name="take-while-clause"></a>Take While (clause)

facultatif. `true` [ Une`Take While` clause](../../../../visual-basic/language-reference/queries/take-while-clause.md) comprend des éléments dans une collection tant qu’une condition spécifiée a la valeur et ignore les éléments restants. Par exemple :
...
## <a name="connect-to-a-database-by-using-linq-to-sql"></a>Se connecter à une base de données à l’aide de LINQ to SQL  
 ...
 Pour obtenir des exemples d’instructions pas à pas, consultez [procédure: Interroger une](how-to-query-a-database-by-using-linq.md) base [de données et procédure: Appeler une procédure](how-to-call-a-stored-procedure-by-using-linq.md)stockée.  
  
## <a name="visual-basic-features-that-support-linq"></a>Fonctionnalités Visual Basic qui prennent en charge LINQ  
 Visual Basic comprend d’autres fonctionnalités notables qui facilitent l’utilisation de LINQ et réduisent la quantité de code que vous devez écrire pour effectuer des requêtes LINQ. Notamment :  
...
|---|---|  
|[XML](../../language-features/xml/index.md)|Décrit les fonctionnalités XML de Visual Basic qui peuvent être interrogées et qui vous permettent d’inclure du XML en tant qu’objets de données de première classe dans votre code Visual Basic.|  
...
## <a name="how-to-and-walkthrough-topics"></a>Rubriques de procédures et procédures pas à pas
 ...
 [Guide pratique pour Trier les résultats de la requête](how-to-sort-query-results-by-using-linq.md)  
  
 [Guide pratique pour Filtrer les résultats de la requête](how-to-filter-query-results-by-using-linq.md)  
  
 [Guide pratique pour Données Count, SUM ou Average](how-to-count-sum-or-average-data-by-using-linq.md)  
...
## <a name="featured-book-chapters"></a>Chapitres de livres proposés  
 [Chapitre 17: LINQ](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/ff652502(v=orm.10)) en [programmation Visual Basic 2008](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/ff652504(v=orm.10))  

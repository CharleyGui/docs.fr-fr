...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>Type de\<«nom variable>» est ambigu parce que les limites de boucle et la variable d’étape ne s’élargissent pas au même type

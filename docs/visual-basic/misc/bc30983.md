...
---
# <a name="type-of-variablename-is-ambiguous-because-the-loop-bounds-and-the-step-variable-do-not-widen-to-the-same-type"></a>Le type de '\<variablename>' est ambigu car les limites de la boucle et la clause d’incrémentation ne sont pas converties en un même type

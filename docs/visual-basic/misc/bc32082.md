...
---
# <a name="type-argument-typeargumentname-is-declared-mustinherit-and-does-not-satisfy-the-new-constraint-for-type-parameter-typeparametername"></a>L’argument de type' \<typeargumentname> 'est déclaré’MustInherit’et ne satisfait pas la contrainte’New’pour le paramètre de type' \<typeparametername> '

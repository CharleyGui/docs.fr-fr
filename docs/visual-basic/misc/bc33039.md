...
---
# <a name="return-and-parameter-types-of-operator-must-be-typename-to-be-used-in-a-for-statement"></a>Les types de retour et de paramètres de '\<operator>' doivent être '\<typename>' pour être utilisés dans une instruction 'For'

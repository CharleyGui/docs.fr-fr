...
---
# <a name="keyword-accessor-of-propertyname-is-obsolete-visual-basic-warning"></a>l' \<keyword> accesseur' 'de' \<propertyname> 'est obsolète (Visual Basic avertissement)

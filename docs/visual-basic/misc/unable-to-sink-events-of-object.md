...
- [Comment : déclencher des événements gérés par un récepteur COM](/previous-versions/dotnet/netframework-4.0/dd8bf0x3(v=vs.100))
- [Procédure pas à pas : gestion des événements](../programming-guide/language-features/events/walkthrough-handling-events.md)

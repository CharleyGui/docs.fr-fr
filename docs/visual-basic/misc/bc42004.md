...
---
# <a name="expression-recursively-calls-containing-operator-operatorsymbol"></a>L’expression appelle de manière récursive l’opérateur conteneur' \<operatorsymbol> '

...
---
# <a name="type-typename-in-assembly-assemblyname1-has-been-forwarded-to-assembly-assemblyname2"></a>Le type' \<typename> 'dans l’assembly' \<assemblyname1> 'a été transféré à l’assembly' \<assemblyname2> '

Le type' \<typename> 'dans l’assembly' \<assemblyname1> 'a été transféré à l’assembly' \<assemblyname2> '. Soit une référence à' \<assemblyname2> 'est manquante dans votre projet, soit le type' \<typename> 'est manquant dans l’assembly' \<assemblyname2> '.  

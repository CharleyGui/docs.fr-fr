...
---
# <a name="extension-method-methodname-has-type-constraints-that-can-never-be-satisfied"></a>La méthode d’extension '\<methodname>' a des contraintes de type qui ne peuvent pas être satisfaites

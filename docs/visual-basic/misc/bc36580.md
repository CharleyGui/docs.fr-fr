...
---
# <a name="extension-method-methodname-defined-in-typename-does-not-have-the-same-signature-as-delegate-delegatename"></a>La méthode d’extension' \<methodName> 'définie dans' \<typeName> 'n’a pas la même signature que le délégué' \<delegateName> '

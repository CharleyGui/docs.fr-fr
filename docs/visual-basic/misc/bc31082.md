...
---
# <a name="variablename-is-not-a-local-variable-or-parameter-and-so-cannot-be-used-as-a-catch-variable"></a>' \<variablename> 'n’est pas une variable locale ou un paramètre, et ne peut donc pas être utilisé en tant que variable’Catch'

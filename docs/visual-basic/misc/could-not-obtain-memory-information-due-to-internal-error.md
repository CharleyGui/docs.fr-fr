...
---
# <a name="could-not-obtain-memory-information-due-to-internal-error"></a>Impossible d’obtenir des informations sur la mémoire en raison d’une erreur interne

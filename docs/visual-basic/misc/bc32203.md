...
---
# <a name="method1-cannot-override-method2-because-it-expands-the-access-of-the-base-method"></a>' \<method1> 'ne peut pas se substituer \<method2> à' ', car il étend l’accès de la méthode de base

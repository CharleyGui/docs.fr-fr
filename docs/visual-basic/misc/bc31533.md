...
---
# <a name="construct-makes-an-indirect-reference-to-project-projectname-which-contains-typename"></a>La construction établit une référence indirecte au projet' \<projectname> ', qui contient' \<typename> '

La construction établit une référence indirecte au projet' \<projectname> ', qui contient' \<typename> '. Ajoutez une référence de projet à' \<projectname> 'à votre projet.  

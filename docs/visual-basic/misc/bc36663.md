...
---
# <a name="option-strict-on-does-not-allow-narrowing-in-implicit-type-conversions-between-method-methodname-and-delegate-delegatename"></a>Option Strict On n’autorise pas les conversions restrictives dans les conversions de types implicites entre la méthode' \<methodname> 'et le délégué' \<delegatename> '

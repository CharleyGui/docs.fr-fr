...
---
# <a name="typename-in-assembly-assemblyname-has-been-forwarded-to-itself-and-so-is-an-unsupported-type"></a>' \<typename> 'dans l’assembly' \<assemblyname> 'a été transféré à lui-même et est donc un type non pris en charge

...
---
# <a name="possible-problem-detected-while-building-assembly-error"></a>Problème possible détecté pendant la génération de l’assembly : \<error>

L’outil ALink, appelé par le compilateur Visual Basic, signale une erreur lors de la génération de l’assembly. Il est possible qu’un assembly signé fasse référence à un assembly non signé.  

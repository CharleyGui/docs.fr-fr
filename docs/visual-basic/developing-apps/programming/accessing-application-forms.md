---
title: Accès aux formulaires d’application
ms.date: 07/20/2015
helpviewer_keywords:
...
|À|Consultez|  
|---|---|  
|Accéder à un formulaire à partir d’un autre formulaire d’une application.|[My.Forms, objet](../../language-reference/objects/my-forms-object.md)|  

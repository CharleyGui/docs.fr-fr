...
|Définir la longueur du défilement à l’écran quand la roulette de la souris est tournée d’un cran.|<xref:Microsoft.VisualBasic.Devices.Mouse.WheelScrollLines>|  

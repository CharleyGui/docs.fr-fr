...
## <a name="remarks"></a>Notes  
 ...
 Pour plus d’informations sur les méthodes et les propriétés de l' `My.Application` objet, consultez les ressources suivantes :  

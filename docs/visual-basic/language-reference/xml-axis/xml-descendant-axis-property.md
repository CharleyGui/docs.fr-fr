...
|Élément|Description|
|----------|-----------------|
|`prefix`|Optionnel. Préfixe d’espace de noms XML pour le nœud descendant. Doit être un espace de noms XML global défini à l’aide d’une instruction `Imports`.|

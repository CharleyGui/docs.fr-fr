...
## <a name="parts"></a>Éléments  
 ...
 Global  
 Optionnel. Vous permet de définir un espace de noms hors de l’espace de noms racine de votre projet. Consultez [espaces de noms dans Visual Basic](../../programming-guide/program-structure/namespaces.md).  
 ...
 `componenttypes`  
 Optionnel. Éléments qui composent l’espace de noms. Celles-ci incluent, sans s’y limiter, les énumérations, les structures, les interfaces, les classes, les modules, les délégués et d’autres espaces de noms.  

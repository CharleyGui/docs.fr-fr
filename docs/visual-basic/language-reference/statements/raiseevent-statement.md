...
## <a name="parts"></a>Composants  
 ...
 `argumentlist`  
 Ce paramètre est facultatif. Liste de variables, de tableaux ou d’expressions délimitée par des virgules. L’argument `argumentlist` doit être placé entre parenthèses. S’il n’y a pas d’arguments, les parenthèses doivent être omises.  

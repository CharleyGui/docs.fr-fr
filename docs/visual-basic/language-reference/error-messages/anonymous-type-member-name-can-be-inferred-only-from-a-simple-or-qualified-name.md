...
```  
 ...
 Pour plus d’informations sur les sources à partir desquelles les types anonymes peuvent et ne peuvent pas déduire les noms et les types de membres, consultez [How pour : Déduire les types et les noms de propriétés dans des déclarations de type anonyme @ no__t-0.  

...
---
# <a name="is-requires-operands-that-have-reference-types-but-this-operand-has-the-value-type-typename"></a>'Is' requiert des opérandes ayant des types référence, mais cet opérande a le type valeur '\<typename>'

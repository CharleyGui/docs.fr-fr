...
|Terme|Définition|  
|---|---|  
|`result`|Requis. Toute expression `Boolean` . The result is the `Boolean` result of comparison of the two expressions.|  

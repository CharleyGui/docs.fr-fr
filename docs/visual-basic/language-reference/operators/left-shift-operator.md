...
## <a name="example"></a>Exemple  
 L’exemple suivant utilise l’opérateur `<<` pour effectuer des décalages arithmétiques vers la gauche sur des valeurs intégrales. Le résultat a toujours le même type de données que celui de l’expression en cours de décalage.  
...
- `result5` correspond à 0 (décalé de 15 places vers la gauche).  

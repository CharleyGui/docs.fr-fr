...
|<xref:Microsoft.VisualBasic.Strings.Filter%2A>|Retourne un tableau de base zéro contenant un sous-ensemble d’un tableau de `String` en fonction des critères de filtre spécifiés.|

...
- Si vous en avez <xref:System.Security.Permissions.PrincipalPermission> la demande, consultez les conseils pour [PrincipalPermissionAttribute est obsolète en tant qu’erreur](../../../../docs/core/compatibility/corefx.md#permission-action). Ces instructions s’appliquent à la fois à <xref:System.Security.Permissions.PrincipalPermission> et <xref:System.Security.Permissions.PrincipalPermissionAttribute> .

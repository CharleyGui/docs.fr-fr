...
Dans les versions précédentes de .NET, certains noms de paramètres d' [assembly de référence](../../../../docs/standard/assembly/reference-assemblies.md) sont différents de leurs paramètres correspondants dans l’assembly d’implémentation. Cela peut provoquer des problèmes lors de l’utilisation d’arguments nommés et de la réflexion.

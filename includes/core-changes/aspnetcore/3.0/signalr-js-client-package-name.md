...
Pour réagir à cette modification, modifiez les références dans votre *package.jssur* les fichiers, les `require` instructions et les `import` instructions ECMAScript. Aucune API ne changera dans le cadre de ce changement de nom.

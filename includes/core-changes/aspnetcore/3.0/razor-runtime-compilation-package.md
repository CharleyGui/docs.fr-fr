...
En outre, `Microsoft.AspNetCore.Mvc.Razor.RazorViewEngineOptions.AllowRecompilingViewsOnFileChange` a été supprimé. La recompilation sur les modifications de fichier est activée par défaut en référençant le package de `Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation`.
...
1. Ajoutez une référence au package de `Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation`.

...
Si la regénération de votre projet ne résout pas le problème, essayez de définir le commutateur `AppContext`&quot;Switch.System.Workflow.ComponentModel.UseLegacyHashForXomlFileChecksum&quot; sur true. Dans le code, cela donne :
